local function enUS()
    return {
        ...
        ["Mobhealth2/Mobinfo2 found. Please consider MobHealth3 for a better experience."] =
        "Mobhealth2/Mobinfo2 found. Please consider MobHealth3 for a better experience.",
        ["Test"] = "Test",
        ["cmd_config"] = "config",
        ...
        ["Returns shortened names (Marshall Williams = M. Williams)"] =
        "Returns shortened names (Marshall Williams = M. Williams)",
        ["Guildname"] = "Guildname",
        ["Guildrank"] = "Guildrank",
        ["Current level, returns ?? for bosses and players too high"] =
        "Current level, returns ?? for bosses and players too high",
        ["Returns \"Boss\" for bosses and Level+10+ for players too high"] =
        "Returns \"Boss\" for bosses and Level+10+ for players too high",
        ...
        ["\"E\", \"R\", \"RE\" for the respective classification"] =
        "\"E\", \"R\", \"RE\" for the respective classification",
        ...
        ["The same as \"healerhealth\" but displays name on full health"] =
        "The same as \"healerhealth\" but displays name on full health",
        ["Returns the same as \"smart:healmishp\" on friendly units and hp/maxhp on enemies"] =
        "Returns the same as \"smart:healmishp\" on friendly units and hp/maxhp on enemies",
        ["Returns missing hp with healing factored in. Shows status when needed (\"Dead\", \"Offline\", \"Ghost\")"] =
        "Returns missing hp with healing factored in. Shows status when needed (\"Dead\", \"Offline\", \"Ghost\")",
        ["Combo Points"] = "Combo Points",
        ["The classic hp display (hp/maxhp and \"Dead\" if dead etc)"] =
        "The classic hp display (hp/maxhp and \"Dead\" if dead etc)",
        ["Like [smarthealth] but shortened when over 10K"] = "Like [smarthealth] but shortened when over 10K",
        ["Current hp and heal in one number (green when heal is incoming)"] =
        "Current hp and heal in one number (green when heal is incoming)",
        ...
        ["Missing hp after incoming heal (green when heal is incoming)"] =
        "Missing hp after incoming heal (green when heal is incoming)",
        ...
        ["White for unflagged units, green for flagged friendlies and red for flagged enemies"] =
        "White for unflagged units, green for flagged friendlies and red for flagged enemies",
        ["Red for enemies, yellow for neutrals, and green for friendlies"] =
        "Red for enemies, yellow for neutrals, and green for friendlies",
        ["Colors based on your level vs the level of the unit. (grey,green,yellow and red)"] =
        "Colors based on your level vs the level of the unit. (grey,green,yellow and red)",
        ...
        ["target"] = "target",
        ["menu"] = "menu",
        ["Do you really want to reset to default for your current profile?"] =
        "Do you really want to reset to default for your current profile?",
        ...
        ["The profile has been deleted and the default profile has been selected."] =
        "The profile has been deleted and the default profile has been selected.",
