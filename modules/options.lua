...
local OptionsPageNames = { L["General"], L["Player"], L["Pet"], L["Pet Target"], L["Target"], L["ToT"], L["ToToT"], L
    ["Party"], L["Party Target"], L["Party Pet"], L["Raid"], L["Clickcasting"], L["Colors"], L["Profiles"], L
    ["Config Mode"] }
local shownFrame = 1
...
TagsDescs[L["INFO TAGS"]] = {
    ...
    ["threat"] = L["Exact threat vs mob"],
    ["perthreat"] = L["Percent of total threat vs mob"],
    ["pullthreat"] = L["Threat remaining before you pull aggro"],
}
TagsDescs[L["HEALTH AND POWER TAGS"]] = {
    ...
    ["smart:healmishp"] = L
        ["Returns missing hp with healing factored in. Shows status when needed (\"Dead\", \"Offline\", \"Ghost\")"],
    ...
    frame.Callback = function()
        if not ColorPickerFrame:IsVisible() then
            ...
            for _, frame in pairs(LunaUF.Units.frameList) do
                ...
                frame:SetBackdropColor(LunaUF.db.profile.bgcolor.r, LunaUF.db.profile.bgcolor.g,
                    LunaUF.db.profile.bgcolor.b, LunaUF.db.profile.bgalpha)
            end
        end
    end
...
local function CreateTagEditFrame(parent, tagconfig)
    ...
    for barname, tags in pairs(tagconfig) do
        ...
        if barname ~= "castBar" then
            ...
            frame[barname].leftsize = CreateFrame("Slider", "LeftSize" .. parent.id .. barname .. "Slider", frame,
            ...
            frame[barname].rightsize = CreateFrame("Slider", "RightSize" .. parent.id .. barname .. "Slider", frame,
                "OptionsSliderTemplate")
            ...
            frame[barname].middlesize = CreateFrame("Slider", "MiddleSize" .. parent.id .. barname .. "Slider", frame,
                "OptionsSliderTemplate")
...
function LunaUF:LoadOptions()
    for i, unit in pairs({ [2] = "player", [3] = "pet", [4] = "pettarget", [5] = "target", [6] = "targettarget", [7] = "targettargettarget", [8] = "party", [9] = "partytarget", [10] = "partypet", [11] = "raid" }) do
        ...
        LunaOptionsFrame.pages[i].indicators.load(LunaOptionsFrame.pages[i].indicators,
            LunaUF.db.profile.units[unit].indicators.icons)
        ...
        LunaUF.db.profile.units[unit].healthBar.classGradient =
            LunaUF.db.profile.units[unit].healthBar.colorType == "class" and
            LunaUF.db.profile.units[unit].healthBar.classGradient
        ...
        RefreshAuraWindow(LunaOptionsFrame.pages[i].EmphasizeBuffsBG.controls,
            LunaOptionsFrame.pages[i].EmphasizeBuffsBG.config, LunaOptionsFrame.pages[i].EmphasizeBuffsBG.slot)
        RefreshAuraWindow(LunaOptionsFrame.pages[i].EmphasizeDebuffsBG.controls,
            LunaOptionsFrame.pages[i].EmphasizeDebuffsBG.config, LunaOptionsFrame.pages[i].EmphasizeDebuffsBG.slot)
        if (unit == "player") then
            LunaOptionsFrame.pages[i].enableaurastimertext:SetChecked(LunaUF.db.profile.units[unit].auras
                .timertextenabled)
            LunaOptionsFrame.pages[i].auratimertextbigfontsizeslider:SetValue(LunaUF.db.profile.units[unit].auras
                .timertextbigsize)
            LunaOptionsFrame.pages[i].auratimertextsmallfontsizeslider:SetValue(LunaUF.db.profile.units[unit].auras
                .timertextsmallsize)
        ...
        LunaOptionsFrame.pages[i].barorder.load(LunaOptionsFrame.pages[i].barorder,
            LunaUF.db.profile.units[unit].barorder)
    end
    ...
    LunaOptionsFrame.pages[page].inrangebelowthresholdslider:SetValue(LunaUF.db.profile.units.raid.healththreshold
        .inRangeBelowAlpha)
    LunaOptionsFrame.pages[page].inrangeabovethresholdslider:SetValue(LunaUF.db.profile.units.raid.healththreshold
        .inRangeAboveAlpha)
    LunaOptionsFrame.pages[page].outrangebelowthresholdslider:SetValue(LunaUF.db.profile.units.raid.healththreshold
        .outOfRangeBelowAlpha)
    --
    ...
    LunaOptionsFrame.pages[page].aggrocolor.load(LunaOptionsFrame.pages[page].aggrocolor,
        LunaUF.db.profile.units.raid.squares.aggrocolor)
    ...
    LunaOptionsFrame.pages[page].firstbuffcolor.load(LunaOptionsFrame.pages[page].firstbuffcolor,
        LunaUF.db.profile.units.raid.squares.buffs.colors[1])
    LunaOptionsFrame.pages[page].secondbuff:SetText(LunaUF.db.profile.units.raid.squares.buffs.names[2])
    LunaOptionsFrame.pages[page].secondbuffcolor.load(LunaOptionsFrame.pages[page].secondbuffcolor,
        LunaUF.db.profile.units.raid.squares.buffs.colors[2])
    LunaOptionsFrame.pages[page].thirdbuff:SetText(LunaUF.db.profile.units.raid.squares.buffs.names[3])
    LunaOptionsFrame.pages[page].thirdbuffcolor.load(LunaOptionsFrame.pages[page].thirdbuffcolor,
        LunaUF.db.profile.units.raid.squares.buffs.colors[3])
    LunaOptionsFrame.pages[page].firstdebuff:SetText(LunaUF.db.profile.units.raid.squares.debuffs.names[1])
    LunaOptionsFrame.pages[page].firstdebuffcolor.load(LunaOptionsFrame.pages[page].firstdebuffcolor,
        LunaUF.db.profile.units.raid.squares.debuffs.colors[1])
    LunaOptionsFrame.pages[page].seconddebuff:SetText(LunaUF.db.profile.units.raid.squares.debuffs.names[2])
    LunaOptionsFrame.pages[page].seconddebuffcolor.load(LunaOptionsFrame.pages[page].seconddebuffcolor,
        LunaUF.db.profile.units.raid.squares.debuffs.colors[2])
    LunaOptionsFrame.pages[page].thirddebuff:SetText(LunaUF.db.profile.units.raid.squares.debuffs.names[3])
    LunaOptionsFrame.pages[page].thirddebuffcolor.load(LunaOptionsFrame.pages[page].thirddebuffcolor,
        LunaUF.db.profile.units.raid.squares.debuffs.colors[3])
    ...
    for i, class in ipairs({ "PRIEST", "PALADIN", "SHAMAN", "WARRIOR", "ROGUE", "MAGE", "WARLOCK", "DRUID", "HUNTER" }) do
        LunaOptionsFrame.pages[page][class].load(LunaOptionsFrame.pages[page][class],
            LunaUF.db.profile.classColors[class])
    end
...
function LunaUF:CreateOptionsMenu()
    ...
    LunaOptionsFrame.help:SetScript("OnClick",
        function()
            if LunaOptionsFrame.Helpframe:IsShown() then
    ...
    for i, name in ipairs(OptionsPageNames) do
        ...
        LunaOptionsFrame.Sliders[i]:SetScript("OnValueChanged",
            function() this.ScrollFrame:SetVerticalScroll(this.ScrollFrame:GetVerticalScrollRange() * this:GetValue()) end)
    ...
    LunaOptionsFrame.Button0 = LunaUF:CreateOptionsButton(1, "LunaGeneralButton", L["General"], LunaOptionsFrame,
        "TOPLEFT", 20, -60)
    LunaOptionsFrame.Button1 = LunaUF:CreateOptionsButton(2, "LunaPlayerButton", L["Player"], LunaOptionsFrame.Button0,
        "BOTTOMLEFT", 0, -2)
    LunaOptionsFrame.Button2 = LunaUF:CreateOptionsButton(3, "LunaPetButton", L["Pet"], LunaOptionsFrame.Button1,
        "BOTTOMLEFT", 0, -2)
    LunaOptionsFrame.Button3 = LunaUF:CreateOptionsButton(4, "LunaPetTargetButton", L["Pet Target"],
        LunaOptionsFrame.Button2, "BOTTOMLEFT", 0, -2)
    LunaOptionsFrame.Button4 = LunaUF:CreateOptionsButton(5, "LunaTargetButton", L["Target"], LunaOptionsFrame.Button3,
        "BOTTOMLEFT", 0, -2)
    LunaOptionsFrame.Button5 = LunaUF:CreateOptionsButton(6, "LunaToTButton", L["ToT"], LunaOptionsFrame.Button4,
        "BOTTOMLEFT", 0, -2)
    LunaOptionsFrame.Button6 = LunaUF:CreateOptionsButton(7, "LunaToToTButton", L["ToToT"], LunaOptionsFrame.Button5,
        "BOTTOMLEFT", 0, -2)
    LunaOptionsFrame.Button7 = LunaUF:CreateOptionsButton(8, "LunaPartyButton", L["Party"], LunaOptionsFrame.Button6,
        "BOTTOMLEFT", 0, -2)
    LunaOptionsFrame.Button8 = LunaUF:CreateOptionsButton(9, "LunaPartyTargetButton", L["Party Target"],
        LunaOptionsFrame.Button7, "BOTTOMLEFT", 0, -2)
    LunaOptionsFrame.Button9 = LunaUF:CreateOptionsButton(10, "LunaPartyPetButton", L["Party Pet"],
        LunaOptionsFrame.Button8, "BOTTOMLEFT", 0, -2)
    LunaOptionsFrame.Button10 = LunaUF:CreateOptionsButton(11, "LunaRaidButton", L["Raid"], LunaOptionsFrame.Button9,
        "BOTTOMLEFT", 0, -2)
    LunaOptionsFrame.Button11 = LunaUF:CreateOptionsButton(12, "LunaClickcastingButton", L["Clickcasting"],
        LunaOptionsFrame.Button10, "BOTTOMLEFT", 0, -2)
    LunaOptionsFrame.Button12 = LunaUF:CreateOptionsButton(13, "LunaColorsButton", L["Colors"], LunaOptionsFrame
        .Button11, "BOTTOMLEFT", 0, -2)
    ...
    local page = 1
    LunaOptionsFrame.pages[page].fontHeader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    ...
    LunaOptionsFrame.pages[page].FontSelect = CreateFrame("Button", "FontSelector", LunaOptionsFrame.pages[page],
    ...
    LunaOptionsFrame.pages[page].textureHeader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    ...
    LunaOptionsFrame.pages[page].textureDesc = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
    ...
    LunaOptionsFrame.pages[page].TextureSelect = CreateFrame("Button", "TextureSelector", LunaOptionsFrame.pages[page],
        "UIDropDownMenuTemplate")
    ...
    LunaOptionsFrame.pages[page].stretch = CreateFrame("CheckButton", "EnableStretch", LunaOptionsFrame.pages[page],
    ...
    LunaOptionsFrame.pages[page].AuraDesc = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlightSmall")
    ...
    LunaOptionsFrame.pages[page].AuraBorderSelect = CreateFrame("Button", "AuraBorderSelector",
        LunaOptionsFrame.pages[page], "UIDropDownMenuTemplate")
    ...
    LunaOptionsFrame.pages[page].Tooltips = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    ...
    LunaOptionsFrame.pages[page].enableTTips = CreateFrame("CheckButton", "EnableTTips", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    ...
    LunaOptionsFrame.pages[page].enableTTipscombat = CreateFrame("CheckButton", "EnableTTipsCombat",
        LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
    ...
    LunaOptionsFrame.pages[page].BarTrans = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    ...
    LunaOptionsFrame.pages[page].baralphaslider = CreateFrame("Slider", "BarAlphaSlider", LunaOptionsFrame.pages[page],
        "OptionsSliderTemplate")
    ...
    LunaOptionsFrame.pages[page].bgbaralphaslider = CreateFrame("Slider", "BgBarAlphaSlider",
        LunaOptionsFrame.pages[page], "OptionsSliderTemplate")
    ...
    LunaOptionsFrame.pages[page].bgbaralphaslider:SetScript("OnValueChanged", function()
        ...
        getglobal("BgBarAlphaSliderText"):SetText(L["Background alpha"] .. ": " .. LunaUF.db.profile.bars
            .backgroundAlpha)
        for _, frame in pairs(LunaUF.Units.frameList) do
            if frame:IsVisible() then
                LunaUF.Units.FullUpdate(frame)
    ...
    LunaOptionsFrame.pages[page].bgbaralphaslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page], "BOTTOMLEFT", 260,
        -270)
    LunaOptionsFrame.pages[page].bgbaralphaslider:SetWidth(220)

    LunaOptionsFrame.pages[page].framebgheader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    ...
    LunaOptionsFrame.pages[page].bgcolor = CreateColorSelect(LunaOptionsFrame.pages[page], LunaUF.db.profile.bgcolor,
        "BGColor")
    LunaOptionsFrame.pages[page].bgcolor:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].framebgheader, "TOPLEFT", 0,
        -40)
    ...
    LunaOptionsFrame.pages[page].bgalphaslider = CreateFrame("Slider", "BgAlphaSlider", LunaOptionsFrame.pages[page],
        "OptionsSliderTemplate")
    ...
    LunaOptionsFrame.pages[page].bgalphaslider:SetScript("OnValueChanged", function()
        ...
        for _, frame in pairs(LunaUF.Units.frameList) do
            frame:SetBackdropColor(LunaUF.db.profile.bgcolor.r, LunaUF.db.profile.bgcolor.g, LunaUF.db.profile.bgcolor.b,
                LunaUF.db.profile.bgalpha)
        end
    end)
    ...
    LunaOptionsFrame.pages[page].blizzheader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    ...
    LunaOptionsFrame.pages[page].castbar = CreateFrame("CheckButton", "BlizzCastbar", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    ...
    LunaOptionsFrame.pages[page].buffs = CreateFrame("CheckButton", "BlizzBuffs", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    ...
    LunaOptionsFrame.pages[page].weaponbuffs = CreateFrame("CheckButton", "BlizzWeaponbuffs",
        LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
    ...
    LunaOptionsFrame.pages[page].player = CreateFrame("CheckButton", "BlizzPlayer", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    ...
    LunaOptionsFrame.pages[page].pet = CreateFrame("CheckButton", "BlizzPet", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    ...
    LunaOptionsFrame.pages[page].party = CreateFrame("CheckButton", "BlizzParty", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    ...
    LunaOptionsFrame.pages[page].target = CreateFrame("CheckButton", "BlizzTarget", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    ...
    LunaOptionsFrame.pages[page].mouseover = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    ...
    LunaOptionsFrame.pages[page].mouseovercheck = CreateFrame("CheckButton", "Mouseover3D", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    ...
    LunaOptionsFrame.pages[page].RangeCheck = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    ...
    LunaOptionsFrame.pages[page].rangepolling = CreateFrame("Slider", "RangePollingRate", LunaOptionsFrame.pages[page],
        "OptionsSliderTemplate")
    ...
    LunaOptionsFrame.pages[page].rangecl = CreateFrame("CheckButton", "RangeCombatLog", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    ...
    LunaOptionsFrame.pages[page].rangelos = CreateFrame("CheckButton", "RangeLoS", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].rangelos:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page], "TOPLEFT", 280, -610)
    ...
    LunaOptionsFrame.pages[page].enemyCastbar = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    ...
    LunaOptionsFrame.pages[page].ecast = CreateFrame("CheckButton", "LunaEnemyCastBars", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].ecast:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page], "TOPLEFT", 20, -670)
    ...
    for i = 2, 11 do
        ...
        LunaOptionsFrame.pages[i].enable = CreateFrame("CheckButton", "Enable" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        ...
        LunaOptionsFrame.pages[i].heightslider = CreateFrame("Slider", "HeightSlider" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
        ...
        LunaOptionsFrame.pages[i].heightslider:SetScript("OnValueChanged", function()
            ...
            getglobal("HeightSlider" .. unit .. "Text"):SetText(L["Height"] .. ": " ..
                LunaUF.db.profile.units[unit].size.y)
            LunaUF.Units:InitializeFrame(unit)
        end)
        ...
        LunaOptionsFrame.pages[i].widthslider = CreateFrame("Slider", "WidthSlider" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
        ...
        LunaOptionsFrame.pages[i].widthslider:SetScript("OnValueChanged", function()
            ...
            getglobal("WidthSlider" .. unit .. "Text"):SetText(L["Width"] .. ": " .. LunaUF.db.profile.units[unit].size
                .x)
            LunaUF.Units:InitializeFrame(unit)
        end)
        LunaOptionsFrame.pages[i].widthslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].heightslider, "BOTTOMLEFT", 0,
            -30)
        LunaOptionsFrame.pages[i].widthslider:SetWidth(460)

        LunaOptionsFrame.pages[i].scaleslider = CreateFrame("Slider", "ScaleSlider" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
        ...
        LunaOptionsFrame.pages[i].scaleslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].widthslider, "BOTTOMLEFT", 0,
            -30)
        LunaOptionsFrame.pages[i].scaleslider:SetWidth(460)

        LunaOptionsFrame.pages[i].positionsHeader = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlight")
        LunaOptionsFrame.pages[i].positionsHeader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].scaleslider, "BOTTOMLEFT",
            0, -30)
        ...
        LunaOptionsFrame.pages[i].xInput = CreateFrame("Editbox", "xInput" .. LunaOptionsFrame.pages[i].id,
            LunaOptionsFrame.pages[i], "InputBoxTemplate")
        ...
        LunaOptionsFrame.pages[i].xInput:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].positionsHeader, "BOTTOMLEFT", 50,
            -30)
        ...
        LunaOptionsFrame.pages[i].yInput = CreateFrame("Editbox", "yInput" .. LunaOptionsFrame.pages[i].id,
            LunaOptionsFrame.pages[i], "InputBoxTemplate")
        ...
        LunaOptionsFrame.pages[i].ButtonUp = CreateFrame("Button", "ButtonUp" .. LunaOptionsFrame.pages[i].id,
            LunaOptionsFrame.pages[i], "UIPanelButtonTemplate")
        ...
        LunaOptionsFrame.pages[i].ButtonDown = CreateFrame("Button", "ButtonDown" .. LunaOptionsFrame.pages[i].id,
            LunaOptionsFrame.pages[i], "UIPanelButtonTemplate")
        ...
        LunaOptionsFrame.pages[i].ButtonLeft = CreateFrame("Button", "ButtonLeft" .. LunaOptionsFrame.pages[i].id,
            LunaOptionsFrame.pages[i], "UIPanelButtonTemplate")
        ...
        LunaOptionsFrame.pages[i].ButtonRight = CreateFrame("Button", "ButtonRight" .. LunaOptionsFrame.pages[i].id,
            LunaOptionsFrame.pages[i], "UIPanelButtonTemplate")
        ...
        LunaOptionsFrame.pages[i].indicatorsHeader = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlight")
        LunaOptionsFrame.pages[i].indicatorsHeader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].positionsHeader,
            "BOTTOMLEFT", 0, -80)
        ...
        LunaOptionsFrame.pages[i].indicators = CreateIndicatorOptionsFrame(LunaOptionsFrame.pages[i],
            LunaUF.db.profile.units[LunaUF.unitList[i - 1]].indicators.icons)
        LunaOptionsFrame.pages[i].indicators:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].indicatorsHeader, "BOTTOMLEFT",
            0, 20)

        LunaOptionsFrame.pages[i].bordersHeader = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlight")
        LunaOptionsFrame.pages[i].bordersHeader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].indicators, "BOTTOMLEFT", 0,
            0)
        ...
        LunaOptionsFrame.pages[i].enableBorders = CreateFrame("CheckButton", "Enable" .. LunaUF.unitList[i - 1] ..
            "Borders", LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].enableBorders:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].bordersHeader, "BOTTOMLEFT",
            0, -10)
        ...
        LunaOptionsFrame.pages[i].bordersMode = CreateFrame("Button", "BordersMode" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "UIDropDownMenuTemplate")
        LunaOptionsFrame.pages[i].bordersMode:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].bordersHeader, "BOTTOMLEFT",
            0, -50)
        ...
        LunaOptionsFrame.pages[i].dispelOption = CreateFrame("CheckButton", "Enable" ..
            LunaUF.unitList[i - 1] .. "BordersDisp", LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        ...
        LunaOptionsFrame.pages[i].dispelOption:SetScript("OnClick", function()
            local unit = this:GetParent().id
            LunaUF.db.profile.units[unit].borders.owndispdebuffs = not LunaUF.db.profile.units[unit].borders
                .owndispdebuffs
            for _, frame in pairs(LunaUF.Units.frameList) do
                if frame.unitGroup == unit then
                    LunaUF.Units:SetupFrameModules(frame)
        ...
        LunaOptionsFrame.pages[i].faderheader = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlight")
        LunaOptionsFrame.pages[i].faderheader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].bordersHeader, "BOTTOMLEFT",
            0, -90)
        ...
        LunaOptionsFrame.pages[i].enableFader = CreateFrame("CheckButton", "Enable" .. LunaUF.unitList[i - 1] .. "Fader",
            LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].enableFader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].faderheader, "BOTTOMLEFT", 0,
            -10)
        ...
        LunaOptionsFrame.pages[i].FaderCombatslider = CreateFrame("Slider", "FaderCombatSlider" .. LunaUF.unitList
            [i - 1],
            LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
        ...
        LunaOptionsFrame.pages[i].FaderCombatslider:SetScript("OnValueChanged", function()
            ...
            getglobal("FaderCombatSlider" .. unit .. "Text"):SetText(L["Combat alpha"] ..
                ": " .. LunaUF.db.profile.units[unit].fader.combatAlpha)
            for _, frame in pairs(LunaUF.Units.frameList) do
                if frame.unitGroup == unit then
                    LunaUF.Units:SetupFrameModules(frame)
                end
        ...
        LunaOptionsFrame.pages[i].FaderCombatslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].faderheader,
            "BOTTOMLEFT", 0, -50)
        LunaOptionsFrame.pages[i].FaderCombatslider:SetWidth(200)

        LunaOptionsFrame.pages[i].FaderNonCombatslider = CreateFrame("Slider",
            "FaderNonCombatSlider" .. LunaUF.unitList[i - 1], LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
        ...
        LunaOptionsFrame.pages[i].FaderNonCombatslider:SetScript("OnValueChanged", function()
            ...
            getglobal("FaderNonCombatSlider" .. unit .. "Text"):SetText(L["Non combat alpha"] ..
                ": " .. LunaUF.db.profile.units[unit].fader.inactiveAlpha)
            for _, frame in pairs(LunaUF.Units.frameList) do
                if frame.unitGroup == unit then
                    LunaUF.Units:SetupFrameModules(frame)
                end
        ...
        LunaOptionsFrame.pages[i].FaderNonCombatslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].faderheader,
            "BOTTOMLEFT", 220, -50)
        LunaOptionsFrame.pages[i].FaderNonCombatslider:SetWidth(200)

        LunaOptionsFrame.pages[i].speedyFade = CreateFrame("CheckButton", "Speedy" .. LunaUF.unitList[i - 1] .. "Fade",
            LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].speedyFade:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].FaderCombatslider,
            "BOTTOMLEFT", 0, -25)
        ...
        LunaOptionsFrame.pages[i].ctextheader = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlight")
        LunaOptionsFrame.pages[i].ctextheader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].faderheader, "BOTTOMLEFT", 0,
            -130)
        ...
        LunaOptionsFrame.pages[i].enableCtext = CreateFrame("CheckButton", "Enable" .. LunaUF.unitList[i - 1] ..
            "CombatText", LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].enableCtext:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].ctextheader, "BOTTOMLEFT", 0,
            -10)
        ...
        LunaOptionsFrame.pages[i].ctextscaleslider = CreateFrame("Slider", "CtextScale" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
        ...
        LunaOptionsFrame.pages[i].ctextscaleslider:SetScript("OnValueChanged", function()
            ...
            getglobal("CtextScale" .. unit .. "Text"):SetText(L["Size"] ..
                ": " .. LunaUF.db.profile.units[unit].combatText.size)
            for _, frame in pairs(LunaUF.Units.frameList) do
                if frame.unitGroup == unit then
                    LunaUF.Units:SetupFrameModules(frame)
                end
        ...
        LunaOptionsFrame.pages[i].ctextscaleslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].ctextheader,
            "BOTTOMLEFT", 220, -10)
        LunaOptionsFrame.pages[i].ctextscaleslider:SetWidth(200)

        LunaOptionsFrame.pages[i].ctextXslider = CreateFrame("Slider", "CtextXSlider" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
        ...
        LunaOptionsFrame.pages[i].ctextXslider:SetScript("OnValueChanged", function()
            ...
            getglobal("CtextXSlider" .. unit .. "Text"):SetText("X: " .. LunaUF.db.profile.units[unit].combatText
                .xoffset)
            for _, frame in pairs(LunaUF.Units.frameList) do
                if frame.unitGroup == unit then
                    LunaUF.Units:SetupFrameModules(frame)
        ...
        LunaOptionsFrame.pages[i].ctextXslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].ctextheader, "BOTTOMLEFT", 0,
            -50)
        LunaOptionsFrame.pages[i].ctextXslider:SetWidth(200)

        LunaOptionsFrame.pages[i].ctextYslider = CreateFrame("Slider", "CtextYSlider" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
        ...
        LunaOptionsFrame.pages[i].ctextYslider:SetScript("OnValueChanged", function()
            ...
            getglobal("CtextYSlider" .. unit .. "Text"):SetText("Y: " .. LunaUF.db.profile.units[unit].combatText
                .yoffset)
            for _, frame in pairs(LunaUF.Units.frameList) do
                if frame.unitGroup == unit then
                    LunaUF.Units:SetupFrameModules(frame)
        ...
        LunaOptionsFrame.pages[i].ctextYslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].ctextheader, "BOTTOMLEFT",
            220, -50)
        LunaOptionsFrame.pages[i].ctextYslider:SetWidth(200)

        ----

        LunaOptionsFrame.pages[i].portraitheader = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlight")
        LunaOptionsFrame.pages[i].portraitheader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].ctextheader, "BOTTOMLEFT",
            0, -100)
        ...
        LunaOptionsFrame.pages[i].enablePortrait = CreateFrame("CheckButton", "Enable" ..
            LunaUF.unitList[i - 1] .. "Portrait", LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].enablePortrait:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].portraitheader,
            "BOTTOMLEFT", 0, -10)
        ...
        LunaOptionsFrame.pages[i].portraitType = CreateFrame("Button", "PortraitType" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "UIDropDownMenuTemplate")
        LunaOptionsFrame.pages[i].portraitType:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].portraitheader, "BOTTOMLEFT",
            60, -10)
        ...
        LunaOptionsFrame.pages[i].pTypeDesc = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlightSmall")
        ...
        LunaOptionsFrame.pages[i].portraitSide = CreateFrame("Button", "PortraitSide" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "UIDropDownMenuTemplate")
        LunaOptionsFrame.pages[i].portraitSide:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].portraitheader, "BOTTOMLEFT",
            160, -10)
        ...
        LunaOptionsFrame.pages[i].pSideDesc = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlightSmall")
        ...
        LunaOptionsFrame.pages[i].portraitsizeslider = CreateFrame("Slider", "PortraitSizeSlider" .. LunaUF.unitList
            [i - 1], LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
        ...
        LunaOptionsFrame.pages[i].portraitsizeslider:SetScript("OnValueChanged", function()
            ...
            getglobal("PortraitSizeSlider" .. unit .. "Text"):SetText(L["Size"] ..
                ": " .. LunaUF.db.profile.units[unit].portrait.size)
            for _, frame in pairs(LunaUF.Units.frameList) do
                if frame.unitGroup == unit then
                    LunaUF.Units:SetupFrameModules(frame)
                end
        ...
        LunaOptionsFrame.pages[i].portraitsizeslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].portraitheader,
            "BOTTOMLEFT", 280, -10)
        LunaOptionsFrame.pages[i].portraitsizeslider:SetWidth(190)

        LunaOptionsFrame.pages[i].highlightheader = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlight")
        LunaOptionsFrame.pages[i].highlightheader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].portraitheader,
            "BOTTOMLEFT", 0, -60)
        ...
        LunaOptionsFrame.pages[i].enableHighlight = CreateFrame("CheckButton",
            "Enable" .. LunaUF.unitList[i - 1] .. "Highlight", LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].enableHighlight:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].highlightheader,
            "BOTTOMLEFT", 0, -10)
        ...
        LunaOptionsFrame.pages[i].highlightalphaslider = CreateFrame("Slider",
            "HighlightAlphaSlider" .. LunaUF.unitList[i - 1], LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
        ...
        LunaOptionsFrame.pages[i].highlightalphaslider:SetScript("OnValueChanged", function()
            ...
            getglobal("HighlightAlphaSlider" .. unit .. "Text"):SetText(L["Alpha"] ..
                ": " .. LunaUF.db.profile.units[unit].highlight.alpha)
            for _, frame in pairs(LunaUF.Units.frameList) do
                if frame.unitGroup == unit then
                    LunaUF.Units:SetupFrameModules(frame)
                end
        ...
        LunaOptionsFrame.pages[i].highlightalphaslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].highlightheader,
            "BOTTOMLEFT", 280, -10)
        LunaOptionsFrame.pages[i].highlightalphaslider:SetWidth(190)

        LunaOptionsFrame.pages[i].ontarget = CreateFrame("CheckButton", "OnTarget" .. LunaUF.unitList[i - 1] ..
            "Highlight", LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].ontarget:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].highlightheader, "BOTTOMLEFT", 0,
            -50)
        ...
        LunaOptionsFrame.pages[i].onmouse = CreateFrame("CheckButton", "OnMouse" .. LunaUF.unitList[i - 1] .. "Highlight",
            LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].onmouse:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].highlightheader, "BOTTOMLEFT",
            150, -50)
        ...
        LunaOptionsFrame.pages[i].ondebuff = CreateFrame("CheckButton", "OnDebuff" .. LunaUF.unitList[i - 1] ..
            "Highlight", LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].ondebuff:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].highlightheader, "BOTTOMLEFT",
            300, -50)
        ...
        LunaOptionsFrame.pages[i].healthheader = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlight")
        LunaOptionsFrame.pages[i].healthheader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].highlightheader,
            "BOTTOMLEFT", 0, -100)
        ...
        LunaOptionsFrame.pages[i].enableHealth = CreateFrame("CheckButton", "Enable" .. LunaUF.unitList[i - 1] ..
            "Health", LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].enableHealth:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].healthheader, "BOTTOMLEFT",
            0, -10)
        ...
        LunaOptionsFrame.pages[i].healthsizeslider = CreateFrame("Slider", "HealthSizeSlider" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
        ...
        LunaOptionsFrame.pages[i].healthsizeslider:SetScript("OnValueChanged", function()
            ...
            getglobal("HealthSizeSlider" .. unit .. "Text"):SetText(L["Size"] ..
                ": " .. LunaUF.db.profile.units[unit].healthBar.size)
            for _, frame in pairs(LunaUF.Units.frameList) do
                if frame.unitGroup == unit then
                    LunaUF.Units:SetupFrameModules(frame)
                end
        ...
        LunaOptionsFrame.pages[i].healthsizeslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].healthheader,
            "BOTTOMLEFT", 280, -10)
        LunaOptionsFrame.pages[i].healthsizeslider:SetWidth(190)

        LunaOptionsFrame.pages[i].healthcolor = CreateFrame("Button", "HealthColor" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "UIDropDownMenuTemplate")
        LunaOptionsFrame.pages[i].healthcolor:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].healthheader, "BOTTOMLEFT",
            60, -10)
        ...
        LunaOptionsFrame.pages[i].cTypeDesc = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlightSmall")
        ...
        LunaOptionsFrame.pages[i].healthreact = CreateFrame("Button", "HealthReact" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "UIDropDownMenuTemplate")
        LunaOptionsFrame.pages[i].healthreact:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].healthheader, "BOTTOMLEFT",
            160, -10)
        ...
        LunaOptionsFrame.pages[i].cReactDesc = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlightSmall")
        ...
        LunaOptionsFrame.pages[i].invertHealth = CreateFrame("CheckButton", "Invert" .. LunaUF.unitList[i - 1] ..
            "Health", LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].invertHealth:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].healthheader, "BOTTOMLEFT",
            0, -50)
        ...
        LunaOptionsFrame.pages[i].vertHealth = CreateFrame("CheckButton", "Vertical" .. LunaUF.unitList[i - 1] ..
            "Health", LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].vertHealth:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].healthheader, "BOTTOMLEFT", 90,
            -50)
        ...
        LunaOptionsFrame.pages[i].reverseHealth = CreateFrame("CheckButton", "Reverse" .. LunaUF.unitList[i - 1] ..
            "Health", LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].reverseHealth:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].healthheader, "BOTTOMLEFT",
            180, -50)
        ...
        LunaOptionsFrame.pages[i].classGradient = CreateFrame("CheckButton",
            "ClassGradient" .. LunaUF.unitList[i - 1] .. "Health", LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].classGradient:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].healthheader, "BOTTOMLEFT",
            270, -50)
        ...
        LunaOptionsFrame.pages[i].classGradient:SetScript("OnClick", function()
            local unit = this:GetParent().id
            if LunaUF.db.profile.units[unit].healthBar.colorType == "class" then
                LunaUF.db.profile.units[unit].healthBar.classGradient = not LunaUF.db.profile.units[unit].healthBar
                    .classGradient
            end
        ...
        LunaOptionsFrame.pages[i].powerheader = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlight")
        LunaOptionsFrame.pages[i].powerheader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].healthheader, "BOTTOMLEFT", 0,
            -100)
        ...
        LunaOptionsFrame.pages[i].enablePower = CreateFrame("CheckButton", "Enable" .. LunaUF.unitList[i - 1] .. "Power",
            LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].enablePower:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].powerheader, "BOTTOMLEFT", 0,
            -10)
        ...
        LunaOptionsFrame.pages[i].hidePower = CreateFrame("CheckButton", "Hide" .. LunaUF.unitList[i - 1] .. "Power",
            LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].hidePower:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].powerheader, "BOTTOMLEFT", 80,
            -10)
        ...
        LunaOptionsFrame.pages[i].powersizeslider = CreateFrame("Slider", "PowerSizeSlider" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
        ...
        LunaOptionsFrame.pages[i].powersizeslider:SetScript("OnValueChanged", function()
            ...
            getglobal("PowerSizeSlider" .. unit .. "Text"):SetText(L["Size"] ..
                ": " .. LunaUF.db.profile.units[unit].powerBar.size)
            for _, frame in pairs(LunaUF.Units.frameList) do
                if frame.unitGroup == unit then
                    LunaUF.Units:SetupFrameModules(frame)
                end
        ...
        LunaOptionsFrame.pages[i].powersizeslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].powerheader, "BOTTOMLEFT",
            280, -10)
        LunaOptionsFrame.pages[i].powersizeslider:SetWidth(190)

        LunaOptionsFrame.pages[i].invertPower = CreateFrame("CheckButton", "Invert" .. LunaUF.unitList[i - 1] .. "Power",
            LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].invertPower:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].powerheader, "BOTTOMLEFT", 0,
            -50)
        ...
        LunaOptionsFrame.pages[i].vertPower = CreateFrame("CheckButton", "Vertical" .. LunaUF.unitList[i - 1] .. "Power",
            LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].vertPower:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].powerheader, "BOTTOMLEFT", 90,
            -50)
        ...
        LunaOptionsFrame.pages[i].reversePower = CreateFrame("CheckButton", "Reverse" .. LunaUF.unitList[i - 1] ..
            "Power", LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].reversePower:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].powerheader, "BOTTOMLEFT", 0,
            -90)
        ...
        LunaOptionsFrame.pages[i].emptyheader = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlight")
        LunaOptionsFrame.pages[i].emptyheader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].powerheader, "BOTTOMLEFT", 0,
            -140)
        ...
        LunaOptionsFrame.pages[i].enableempty = CreateFrame("CheckButton", "Enable" .. LunaUF.unitList[i - 1] .. "Empty",
            LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].enableempty:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].emptyheader, "BOTTOMLEFT", 0,
            -10)
        ...
        LunaOptionsFrame.pages[i].emptysizeslider = CreateFrame("Slider", "EmptySizeSlider" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
        ...
        LunaOptionsFrame.pages[i].emptysizeslider:SetScript("OnValueChanged", function()
            ...
            getglobal("EmptySizeSlider" .. unit .. "Text"):SetText(L["Size"] ..
                ": " .. LunaUF.db.profile.units[unit].emptyBar.size)
            for _, frame in pairs(LunaUF.Units.frameList) do
                if frame.unitGroup == unit then
        ...
        LunaOptionsFrame.pages[i].emptysizeslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].emptyheader, "BOTTOMLEFT",
            280, -10)
        LunaOptionsFrame.pages[i].emptysizeslider:SetWidth(190)

        LunaOptionsFrame.pages[i].castheader = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlight")
        LunaOptionsFrame.pages[i].castheader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].emptyheader, "BOTTOMLEFT", 0,
            -60)
        ...
        LunaOptionsFrame.pages[i].enablecast = CreateFrame("CheckButton", "Enable" .. LunaUF.unitList[i - 1] .. "Cast",
            LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].enablecast:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].castheader, "BOTTOMLEFT", 0,
            -10)
        ...
        LunaOptionsFrame.pages[i].casthide = CreateFrame("CheckButton", "Cast" .. LunaUF.unitList[i - 1] .. "Hide",
            LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].casthide:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].castheader, "BOTTOMLEFT", 80,
            -10)
        ...
        LunaOptionsFrame.pages[i].casticon = CreateFrame("CheckButton", "Cast" .. LunaUF.unitList[i - 1] .. "Icon",
            LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].casticon:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].castheader, "BOTTOMLEFT", 160,
            -10)
        ...
        LunaOptionsFrame.pages[i].castvertical = CreateFrame("CheckButton", "Cast" .. LunaUF.unitList[i - 1] ..
            "Vertical", LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].castvertical:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].castheader, "BOTTOMLEFT", 0,
            -50)
        ...
        LunaOptionsFrame.pages[i].reverseCast = CreateFrame("CheckButton", "Reverse" .. LunaUF.unitList[i - 1] .. "Cast",
            LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].reverseCast:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].castheader, "BOTTOMLEFT", 170,
            -50)
        ...
        LunaOptionsFrame.pages[i].castsizeslider = CreateFrame("Slider", "CastSizeSlider" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
        ...
        LunaOptionsFrame.pages[i].castsizeslider:SetScript("OnValueChanged", function()
            ...
            getglobal("CastSizeSlider" .. unit .. "Text"):SetText(L["Size"] ..
                ": " .. LunaUF.db.profile.units[unit].castBar.size)
            for _, frame in pairs(LunaUF.Units.frameList) do
                if frame.unitGroup == unit then
                    LunaUF.Units:PositionWidgets(frame)
                end
        ...
        LunaOptionsFrame.pages[i].castsizeslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].castheader, "BOTTOMLEFT",
            280, -10)
        LunaOptionsFrame.pages[i].castsizeslider:SetWidth(190)

        if LunaUF.unitList[i - 1] ~= "pettarget" then
            LunaOptionsFrame.pages[i].healheader = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
                "GameFontHighlight")
            LunaOptionsFrame.pages[i].healheader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].castheader, "BOTTOMLEFT",
                0, -90)
            ...
            LunaOptionsFrame.pages[i].enableheal = CreateFrame("CheckButton", "Enable" .. LunaUF.unitList[i - 1] ..
                "Heal", LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
            LunaOptionsFrame.pages[i].enableheal:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].healheader, "BOTTOMLEFT",
                0, -10)
            ...
            LunaOptionsFrame.pages[i].healsizeslider = CreateFrame("Slider", "HealSizeSlider" .. LunaUF.unitList[i - 1],
                LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
            ...
            LunaOptionsFrame.pages[i].healsizeslider:SetScript("OnValueChanged", function()
                ...
                getglobal("HealSizeSlider" .. unit .. "Text"):SetText(L["Size"] ..
                    ": " .. (LunaUF.db.profile.units[unit].incheal.cap * 100))
                for _, frame in pairs(LunaUF.Units.frameList) do
                    if frame.unitGroup == unit then
                        LunaUF.Units.FullUpdate(frame)
                    end
            ...
            LunaOptionsFrame.pages[i].healsizeslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].healheader,
                "BOTTOMLEFT", 280, -10)
            LunaOptionsFrame.pages[i].healsizeslider:SetWidth(190)
        end

        LunaOptionsFrame.pages[i].auraheader = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlight")
        LunaOptionsFrame.pages[i].auraheader:SetPoint("TOPLEFT",
            LunaOptionsFrame.pages[i].healheader or LunaOptionsFrame.pages[i].castheader, "BOTTOMLEFT", 0,
            LunaOptionsFrame.pages[i].healheader and -60 or -90)
        ...
        LunaOptionsFrame.pages[i].showbuffs = CreateFrame("CheckButton", "Show" .. LunaUF.unitList[i - 1] .. "Buffs",
            LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].showbuffs:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].auraheader, "BOTTOMLEFT", 0,
            -10)
        ...
        LunaOptionsFrame.pages[i].buffposition = CreateFrame("Button", "BuffPosition" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "UIDropDownMenuTemplate")
        LunaOptionsFrame.pages[i].buffposition:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].showbuffs, "BOTTOMLEFT", 100,
            30)
        ...
        LunaOptionsFrame.pages[i].BuffPosDesc = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlightSmall")
        ...
        LunaOptionsFrame.pages[i].buffsizeslider = CreateFrame("Slider", "BuffSizeSlider" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
        ...
        LunaOptionsFrame.pages[i].buffsizeslider:SetScript("OnValueChanged", function()
            ...
            getglobal("BuffSizeSlider" .. unit .. "Text"):SetText(L["Size"] ..
                ": " .. LunaUF.db.profile.units[unit].auras.buffsize)
            for _, frame in pairs(LunaUF.Units.frameList) do
                if frame.unitGroup == unit then
                    LunaUF.Units.FullUpdate(frame)
                end
        ...
        LunaOptionsFrame.pages[i].bigbuffsizeslider = CreateFrame("Slider", "BigBuffSizeSlider" .. LunaUF.unitList
            [i - 1],
            LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
        ...
        LunaOptionsFrame.pages[i].bigbuffsizeslider:SetScript("OnValueChanged", function()
            ...
            getglobal("BigBuffSizeSlider" .. unit .. "Text"):SetText(L["Big Size"] ..
                ": " .. LunaUF.db.profile.units[unit].auras.enlargedbuffsize)
            for _, frame in pairs(LunaUF.Units.frameList) do
                if frame.unitGroup == unit then
                    LunaUF.Units.FullUpdate(frame)
                end
        ...
        LunaOptionsFrame.pages[i].bigbuffsizeslider:SetPoint("LEFT", LunaOptionsFrame.pages[i].buffsizeslider, "RIGHT",
            10, 0)
        LunaOptionsFrame.pages[i].bigbuffsizeslider:SetWidth(120)

        LunaOptionsFrame.pages[i].showdebuffs = CreateFrame("CheckButton", "Show" .. LunaUF.unitList[i - 1] .. "Debuffs",
            LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].showdebuffs:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].showbuffs, "BOTTOMLEFT", 0,
            -10)
        ...
        LunaOptionsFrame.pages[i].debuffposition = CreateFrame("Button", "DebuffPosition" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "UIDropDownMenuTemplate")
        LunaOptionsFrame.pages[i].debuffposition:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].showdebuffs, "BOTTOMLEFT",
            100, 30)
        ...
        LunaOptionsFrame.pages[i].DebuffPosDesc = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlightSmall")
        ...
        LunaOptionsFrame.pages[i].debuffsizeslider = CreateFrame("Slider", "DebuffSizeSlider" .. LunaUF.unitList[i - 1],
            LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
        ...
        LunaOptionsFrame.pages[i].debuffsizeslider:SetScript("OnValueChanged", function()
            ...
            getglobal("DebuffSizeSlider" .. unit .. "Text"):SetText(L["Size"] ..
                ": " .. LunaUF.db.profile.units[unit].auras.debuffsize)
            for _, frame in pairs(LunaUF.Units.frameList) do
                if frame.unitGroup == unit then
                    LunaUF.Units.FullUpdate(frame)
                end
        ...
        LunaOptionsFrame.pages[i].debuffsizeslider:SetPoint("LEFT", LunaOptionsFrame.pages[i].showdebuffs, "RIGHT", 190,
            0)
        LunaOptionsFrame.pages[i].debuffsizeslider:SetWidth(120)

        LunaOptionsFrame.pages[i].bigdebuffsizeslider = CreateFrame("Slider", "BigDebuffSizeSlider" ..
            LunaUF.unitList[i - 1], LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
        ...
        LunaOptionsFrame.pages[i].bigdebuffsizeslider:SetScript("OnValueChanged", function()
            ...
            getglobal("BigDebuffSizeSlider" .. unit .. "Text"):SetText(L["Big Size"] ..
                ": " .. LunaUF.db.profile.units[unit].auras.enlargeddebuffsize)
            for _, frame in pairs(LunaUF.Units.frameList) do
                if frame.unitGroup == unit then
                    LunaUF.Units.FullUpdate(frame)
                end
        ...
        LunaOptionsFrame.pages[i].bigdebuffsizeslider:SetPoint("LEFT", LunaOptionsFrame.pages[i].debuffsizeslider,
            "RIGHT", 10, 0)
        LunaOptionsFrame.pages[i].bigdebuffsizeslider:SetWidth(120)

        LunaOptionsFrame.pages[i].enablebordercolor = CreateFrame("CheckButton",
            "Enable" .. LunaUF.unitList[i - 1] .. "BorderColor", LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].enablebordercolor:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].showdebuffs,
            "BOTTOMLEFT", 0, -10)
        ...
        LunaOptionsFrame.pages[i].aurapaddingslider = CreateFrame("Slider", "AuraPaddingSlider" .. LunaUF.unitList
            [i - 1],
            LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
        ...
        LunaOptionsFrame.pages[i].aurapaddingslider:SetScript("OnValueChanged", function()
            ...
            getglobal("AuraPaddingSlider" .. unit .. "Text"):SetText(L["Padding"] ..
                ": " .. LunaUF.db.profile.units[unit].auras.padding)
            for _, frame in pairs(LunaUF.Units.frameList) do
                if frame.unitGroup == unit then
                    LunaUF.Units.FullUpdate(frame)
                end
        ...
        LunaOptionsFrame.pages[i].aurapaddingslider:SetPoint("LEFT", LunaOptionsFrame.pages[i].enablebordercolor, "RIGHT",
            190, 0)
        LunaOptionsFrame.pages[i].aurapaddingslider:SetWidth(120)

        LunaOptionsFrame.pages[i].EmphasizeDesc = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlight")
        LunaOptionsFrame.pages[i].EmphasizeDesc:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].enablebordercolor,
            "BOTTOMLEFT", 200, -20)
        LunaOptionsFrame.pages[i].EmphasizeDesc:SetText(L["Emphasize"])

        LunaOptionsFrame.pages[i].EmphasizeBuffsInput = CreateFrame("Editbox", "EmphasizeBuffsInput" .. i,
            LunaOptionsFrame.pages[i], "InputBoxTemplate")
        ...
        LunaOptionsFrame.pages[i].EmphasizeBuffsInput:SetPoint("TOP", LunaOptionsFrame.pages[i].EmphasizeDesc, "BOTTOM",
            -125, -20)
        LunaOptionsFrame.pages[i].EmphasizeBuffsInput:SetScript("OnEnterPressed", function()
            this:ClearFocus()
        end)

        LunaOptionsFrame.pages[i].EmphasizeBuffsDesc = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlightSmall")
        LunaOptionsFrame.pages[i].EmphasizeBuffsDesc:SetPoint("BOTTOM", LunaOptionsFrame.pages[i].EmphasizeBuffsInput,
            "TOP", 0, 5)
        LunaOptionsFrame.pages[i].EmphasizeBuffsDesc:SetText(L["Buffs"])

        LunaOptionsFrame.pages[i].EmphasizeBuffsAdd = CreateFrame("Button", "EmphasizeBuffsAddButton" .. i,
            LunaOptionsFrame.pages[i], "UIPanelButtonTemplate")
        LunaOptionsFrame.pages[i].EmphasizeBuffsAdd:SetPoint("LEFT", LunaOptionsFrame.pages[i].EmphasizeBuffsInput,
            "RIGHT", 0, 0)
        ...
        LunaOptionsFrame.pages[i].EmphasizeBuffsAdd:SetScript("OnClick", function()
            ...
            if buffname and buffname ~= "" then
                ...
                RefreshAuraWindow(parent.EmphasizeBuffsBG.controls, parent.EmphasizeBuffsBG.config,
                    parent.EmphasizeBuffsBG.slot)
                for _, frame in pairs(LunaUF.Units.frameList) do
        ...
        LunaOptionsFrame.pages[i].EmphasizeBuffsBG:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].EmphasizeBuffsInput,
            "BOTTOMLEFT", 0, -10)
        ...
        LunaOptionsFrame.pages[i].EmphasizeBuffsBG.config = LunaUF.db.profile.units[LunaUF.unitList[i - 1]].auras
            .emphasizeAuras.buffs
        LunaOptionsFrame.pages[i].EmphasizeBuffsBG.slot = 1

        LunaOptionsFrame.pages[i].EmphasizeBuffsUp = CreateFrame("Button", "EmphasizeBuffsUpButton" .. i,
            LunaOptionsFrame.pages[i], "UIPanelButtonTemplate")
        LunaOptionsFrame.pages[i].EmphasizeBuffsUp:SetPoint("BOTTOMLEFT", LunaOptionsFrame.pages[i].EmphasizeBuffsBG,
            "RIGHT", 2, 5)
        ...
        LunaOptionsFrame.pages[i].EmphasizeBuffsUp.config = LunaUF.db.profile.units[LunaUF.unitList[i - 1]].auras
            .emphasizeAuras.buffs
        ...
        LunaOptionsFrame.pages[i].EmphasizeBuffsDown = CreateFrame("Button", "EmphasizeBuffsDownButton" .. i,
            LunaOptionsFrame.pages[i], "UIPanelButtonTemplate")
        LunaOptionsFrame.pages[i].EmphasizeBuffsDown:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].EmphasizeBuffsBG,
            "RIGHT", 2, -5)
        ...
        LunaOptionsFrame.pages[i].EmphasizeBuffsDown.config = LunaUF.db.profile.units[LunaUF.unitList[i - 1]].auras
            .emphasizeAuras.buffs
        ...
        for k = 1, 3 do
            ...
            LunaOptionsFrame.pages[i].EmphasizeBuffsBG.controls[k][1] = LunaOptionsFrame.pages[i].EmphasizeBuffsBG
            ...
            LunaOptionsFrame.pages[i].EmphasizeBuffsBG.controls[k][2] = CreateFrame("Button",
                "EmphasizeBuffsDeleteButton" .. i .. k, LunaOptionsFrame.pages[i].EmphasizeBuffsBG,
            ...
            LunaOptionsFrame.pages[i].EmphasizeBuffsBG.controls[k][2].config = LunaOptionsFrame.pages[i]
                .EmphasizeBuffsBG
        ...
        LunaOptionsFrame.pages[i].EmphasizeBuffsBG.controls[1][1]:SetPoint("TOPLEFT",
            LunaOptionsFrame.pages[i].EmphasizeBuffsBG, "TOPLEFT", 5, -5)
        LunaOptionsFrame.pages[i].EmphasizeBuffsBG.controls[1][2]:SetPoint("TOPRIGHT",
            LunaOptionsFrame.pages[i].EmphasizeBuffsBG, "TOPRIGHT", 0, 0)
        LunaOptionsFrame.pages[i].EmphasizeBuffsBG.controls[2][1]:SetPoint("LEFT",
            LunaOptionsFrame.pages[i].EmphasizeBuffsBG, "LEFT", 5, 0)
        LunaOptionsFrame.pages[i].EmphasizeBuffsBG.controls[2][2]:SetPoint("RIGHT",
            LunaOptionsFrame.pages[i].EmphasizeBuffsBG, "RIGHT", 0, 0)
        LunaOptionsFrame.pages[i].EmphasizeBuffsBG.controls[3][1]:SetPoint("BOTTOMLEFT",
            LunaOptionsFrame.pages[i].EmphasizeBuffsBG, "BOTTOMLEFT", 5, 5)
        LunaOptionsFrame.pages[i].EmphasizeBuffsBG.controls[3][2]:SetPoint("BOTTOMRIGHT",
            LunaOptionsFrame.pages[i].EmphasizeBuffsBG, "BOTTOMRIGHT", 0, 0)

        LunaOptionsFrame.pages[i].EmphasizeDebuffsInput = CreateFrame("Editbox", "EmphasizeDebuffsInput" .. i,
            LunaOptionsFrame.pages[i], "InputBoxTemplate")
        ...
        LunaOptionsFrame.pages[i].EmphasizeDebuffsInput:SetPoint("TOP", LunaOptionsFrame.pages[i].EmphasizeDesc, "BOTTOM",
            100, -20)
        LunaOptionsFrame.pages[i].EmphasizeDebuffsInput:SetScript("OnEnterPressed", function()
            this:ClearFocus()
        end)

        LunaOptionsFrame.pages[i].EmphasizeDebuffsDesc = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlightSmall")
        LunaOptionsFrame.pages[i].EmphasizeDebuffsDesc:SetPoint("BOTTOM", LunaOptionsFrame.pages[i]
            .EmphasizeDebuffsInput, "TOP", 0, 5)
        LunaOptionsFrame.pages[i].EmphasizeDebuffsDesc:SetText(L["Debuffs"])

        LunaOptionsFrame.pages[i].EmphasizeDebuffsAdd = CreateFrame("Button", "EmphasizeDebuffsAddButton" .. i,
            LunaOptionsFrame.pages[i], "UIPanelButtonTemplate")
        LunaOptionsFrame.pages[i].EmphasizeDebuffsAdd:SetPoint("LEFT", LunaOptionsFrame.pages[i].EmphasizeDebuffsInput,
            "RIGHT", 0, 0)
        ...
        LunaOptionsFrame.pages[i].EmphasizeDebuffsAdd.config = LunaUF.db.profile.units[LunaUF.unitList[i - 1]].auras
            .emphasizeAuras.debuffs
        LunaOptionsFrame.pages[i].EmphasizeDebuffsAdd:SetScript("OnClick", function()
            ...
            if debuffname and debuffname ~= "" then
                ...
                RefreshAuraWindow(parent.EmphasizeDebuffsBG.controls, parent.EmphasizeDebuffsBG.config,
                    parent.EmphasizeDebuffsBG.slot)
                for _, frame in pairs(LunaUF.Units.frameList) do
                    if frame.unitGroup == parent.id then
                        LunaUF.Units.FullUpdate(frame)
                    end
        ...
        LunaOptionsFrame.pages[i].EmphasizeDebuffsBG = CreateFrame("Frame", "EmphasizeDebuffsBG",
            LunaOptionsFrame.pages[i])
        LunaOptionsFrame.pages[i].EmphasizeDebuffsBG:SetHeight(60)
        LunaOptionsFrame.pages[i].EmphasizeDebuffsBG:SetWidth(175)
        LunaOptionsFrame.pages[i].EmphasizeDebuffsBG:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].EmphasizeDebuffsInput,
            "BOTTOMLEFT", 0, -10)
        ...
        LunaOptionsFrame.pages[i].EmphasizeDebuffsBG.config = LunaUF.db.profile.units[LunaUF.unitList[i - 1]].auras
            .emphasizeAuras.debuffs
        LunaOptionsFrame.pages[i].EmphasizeDebuffsBG.slot = 1

        LunaOptionsFrame.pages[i].EmphasizeDebuffsUp = CreateFrame("Button", "EmphasizeDebuffsUpButton" .. i,
            LunaOptionsFrame.pages[i], "UIPanelButtonTemplate")
        LunaOptionsFrame.pages[i].EmphasizeDebuffsUp:SetPoint("BOTTOMLEFT", LunaOptionsFrame.pages[i].EmphasizeDebuffsBG,
            "RIGHT", 2, 5)
        ...
        LunaOptionsFrame.pages[i].EmphasizeDebuffsUp.config = LunaUF.db.profile.units[LunaUF.unitList[i - 1]].auras
            .emphasizeAuras.debuffs
        ...
        LunaOptionsFrame.pages[i].EmphasizeDebuffsDown = CreateFrame("Button", "EmphasizeDebuffsDownButton" .. i,
            LunaOptionsFrame.pages[i], "UIPanelButtonTemplate")
        LunaOptionsFrame.pages[i].EmphasizeDebuffsDown:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].EmphasizeDebuffsBG,
            "RIGHT", 2, -5)
        ...
        LunaOptionsFrame.pages[i].EmphasizeDebuffsDown.config = LunaUF.db.profile.units[LunaUF.unitList[i - 1]].auras
            .emphasizeAuras.debuffs
        ...
        for k = 1, 3 do
            ...
            LunaOptionsFrame.pages[i].EmphasizeDebuffsBG.controls[k][1] = LunaOptionsFrame.pages[i].EmphasizeDebuffsBG
                :CreateFontString(nil, "OVERLAY", "GameFontHighlightSmall")
            LunaOptionsFrame.pages[i].EmphasizeDebuffsBG.controls[k][1]:SetText("<TESTVALUE>")
            LunaOptionsFrame.pages[i].EmphasizeDebuffsBG.controls[k][2] = CreateFrame("Button",
                "EmphasizeDebuffsDeleteButton" .. i .. k, LunaOptionsFrame.pages[i].EmphasizeDebuffsBG,
                "UIPanelButtonTemplate")
            ...
            LunaOptionsFrame.pages[i].EmphasizeDebuffsBG.controls[k][2].config = LunaOptionsFrame.pages[i]
                .EmphasizeDebuffsBG
        ...
        LunaOptionsFrame.pages[i].EmphasizeDebuffsBG.controls[1][1]:SetPoint("TOPLEFT",
            LunaOptionsFrame.pages[i].EmphasizeDebuffsBG, "TOPLEFT", 5, -5)
        LunaOptionsFrame.pages[i].EmphasizeDebuffsBG.controls[1][2]:SetPoint("TOPRIGHT",
            LunaOptionsFrame.pages[i].EmphasizeDebuffsBG, "TOPRIGHT", 0, 0)
        LunaOptionsFrame.pages[i].EmphasizeDebuffsBG.controls[2][1]:SetPoint("LEFT",
            LunaOptionsFrame.pages[i].EmphasizeDebuffsBG, "LEFT", 5, 0)
        LunaOptionsFrame.pages[i].EmphasizeDebuffsBG.controls[2][2]:SetPoint("RIGHT",
            LunaOptionsFrame.pages[i].EmphasizeDebuffsBG, "RIGHT", 0, 0)
        LunaOptionsFrame.pages[i].EmphasizeDebuffsBG.controls[3][1]:SetPoint("BOTTOMLEFT",
            LunaOptionsFrame.pages[i].EmphasizeDebuffsBG, "BOTTOMLEFT", 5, 5)
        LunaOptionsFrame.pages[i].EmphasizeDebuffsBG.controls[3][2]:SetPoint("BOTTOMRIGHT",
            LunaOptionsFrame.pages[i].EmphasizeDebuffsBG, "BOTTOMRIGHT", 0, 0)
        ...
        if (LunaUF.unitList[i - 1] == "player") then
            LunaOptionsFrame.pages[i].enableaurastimertext = CreateFrame("CheckButton",
                "Enable" .. LunaUF.unitList[i - 1] .. "AurasTimerText", LunaOptionsFrame.pages[i],
                "UICheckButtonTemplate")
            LunaOptionsFrame.pages[i].enableaurastimertext:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i]
                .EmphasizeBuffsBG, "BOTTOMLEFT", -30, -20)
            ...
            LunaOptionsFrame.pages[i].enableaurastimertext:SetScript("OnClick", function()
                local unit = this:GetParent().id
                LunaUF.db.profile.units[unit].auras.timertextenabled = not LunaUF.db.profile.units[unit].auras
                    .timertextenabled
                for _, frame in pairs(LunaUF.Units.frameList) do
                    if frame.unitGroup == unit then
                        LunaUF.Units.FullUpdate(frame)
            ...
            LunaOptionsFrame.pages[i].auratimertextbigfontsizeslider = CreateFrame("Slider",
                "AuraTimerBigFontSlider" .. LunaUF.unitList[i - 1], LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
            ...
            LunaOptionsFrame.pages[i].auratimertextbigfontsizeslider:SetScript("OnValueChanged", function()
                ...
                getglobal("AuraTimerBigFontSlider" .. unit .. "Text"):SetText(L["Big font size"] ..
                    ": " .. LunaUF.db.profile.units[unit].auras.timertextbigsize)
                for _, frame in pairs(LunaUF.Units.frameList) do
                    if frame.unitGroup == unit then
                        LunaUF.Units.FullUpdate(frame)
                    end
            ...
            LunaOptionsFrame.pages[i].auratimertextbigfontsizeslider:SetPoint("LEFT",
                LunaOptionsFrame.pages[i].enableaurastimertext, "RIGHT", 120, 0)
            LunaOptionsFrame.pages[i].auratimertextbigfontsizeslider:SetWidth(150)

            LunaOptionsFrame.pages[i].auratimertextsmallfontsizeslider = CreateFrame("Slider",
                "AuraTimerSmallFontSlider" .. LunaUF.unitList[i - 1], LunaOptionsFrame.pages[i], "OptionsSliderTemplate")
            ...
            LunaOptionsFrame.pages[i].auratimertextsmallfontsizeslider:SetScript("OnValueChanged", function()
                ...
                getglobal("AuraTimerSmallFontSlider" .. unit .. "Text"):SetText(L["Small font size"] ..
                    ": " .. LunaUF.db.profile.units[unit].auras.timertextsmallsize)
                for _, frame in pairs(LunaUF.Units.frameList) do
                    if frame.unitGroup == unit then
                        LunaUF.Units.FullUpdate(frame)
                    end
            ...
            LunaOptionsFrame.pages[i].auratimertextsmallfontsizeslider:SetPoint("LEFT",
                LunaOptionsFrame.pages[i].enableaurastimertext, "RIGHT", 290, 0)
            LunaOptionsFrame.pages[i].auratimertextsmallfontsizeslider:SetWidth(150)

            LunaOptionsFrame.pages[i].enableaurastimerspin = CreateFrame("CheckButton",
                "Enable" .. LunaUF.unitList[i - 1] .. "AurasTimerSpin", LunaOptionsFrame.pages[i],
                "UICheckButtonTemplate")
            LunaOptionsFrame.pages[i].enableaurastimerspin:SetPoint("TOPLEFT",
                LunaOptionsFrame.pages[i].enableaurastimertext, "BOTTOMLEFT", 0, -10)
            ...
            LunaOptionsFrame.pages[i].enableaurastimerspin:SetScript("OnClick", function()
                local unit = this:GetParent().id
                LunaUF.db.profile.units[unit].auras.timerspinenabled = not LunaUF.db.profile.units[unit].auras
                    .timerspinenabled
                for _, frame in pairs(LunaUF.Units.frameList) do
                    if frame.unitGroup == unit then
                        LunaUF.Units.FullUpdate(frame)
            ...
            LunaOptionsFrame.pages[i].wbuffs = CreateFrame("CheckButton", "Enable" .. LunaUF.unitList[i - 1] .. "WBuffs",
                LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
            LunaOptionsFrame.pages[i].wbuffs:SetPoint("LEFT", LunaOptionsFrame.pages[i].enableaurastimerspin, "RIGHT",
                100, 0)
        ...
        LunaOptionsFrame.pages[i].tagheader = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlight")
        LunaOptionsFrame.pages[i].tagheader:SetPoint("TOPLEFT",
            LunaOptionsFrame.pages[i].enableaurastimertext or LunaOptionsFrame.pages[i].auraheader, "BOTTOMLEFT", 0,
            LunaOptionsFrame.pages[i].enableaurastimertext and -60 or -250)
        ...
        LunaOptionsFrame.pages[i].enabletags = CreateFrame("CheckButton", "Enable" .. LunaUF.unitList[i - 1] .. "Tags",
            LunaOptionsFrame.pages[i], "UICheckButtonTemplate")
        LunaOptionsFrame.pages[i].enabletags:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].tagheader, "BOTTOMLEFT", 0,
            -10)
        ...
        LunaOptionsFrame.pages[i].tags = CreateTagEditFrame(LunaOptionsFrame.pages[i],
            LunaUF.db.profile.units[LunaUF.unitList[i - 1]].tags.bartags)
        LunaOptionsFrame.pages[i].tags:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].tagheader, "BOTTOMLEFT", 0, -30)

        LunaOptionsFrame.pages[i].orderheader = LunaOptionsFrame.pages[i]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlight")
        ...
        LunaOptionsFrame.pages[i].barorder = CreateBarOrderWidget(LunaOptionsFrame.pages[i],
            LunaUF.db.profile.units[LunaUF.unitList[i - 1]].barorder)
        LunaOptionsFrame.pages[i].barorder:SetPoint("TOPLEFT", LunaOptionsFrame.pages[i].orderheader, "BOTTOMLEFT", 0,
            -20)
    end

    local page = 2
    LunaOptionsFrame.pages[page].ticker = CreateFrame("CheckButton", "TickerplayerPower", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].ticker:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].powerheader, "BOTTOMLEFT", 180,
        -50)
    ...
    LunaOptionsFrame.pages[page].manausage = CreateFrame("CheckButton", "ManaUsage", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].manausage:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].powerheader, "BOTTOMLEFT",
        320, -50)
    ...
    LunaOptionsFrame.pages[page].totemheader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    LunaOptionsFrame.pages[page].totemheader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].barorder, "BOTTOMLEFT", 0,
        -30)
    ...
    LunaOptionsFrame.pages[page].enabletotem = CreateFrame("CheckButton", "EnableplayerTotems",
        LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].enabletotem:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].totemheader, "BOTTOMLEFT",
        0, -10)
    ...
    LunaOptionsFrame.pages[page].totemhide = CreateFrame("CheckButton", "TotemsplayerHide", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].totemhide:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].totemheader, "BOTTOMLEFT", 80,
        -10)
    ...
    LunaOptionsFrame.pages[page].totemsizeslider = CreateFrame("Slider", "TotemsSizeSlidertarget",
        LunaOptionsFrame.pages[page], "OptionsSliderTemplate")
    ...
    LunaOptionsFrame.pages[page].totemsizeslider:SetScript("OnValueChanged", function()
        ...
        getglobal("TotemsSizeSlidertargetText"):SetText(L["Size"] .. ": " .. LunaUF.db.profile.units.player.totemBar
            .size)
        LunaUF.Units:SetupFrameModules(LunaUF.Units.unitFrames.player)
    end)
    LunaOptionsFrame.pages[page].totemsizeslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].totemheader,
        "BOTTOMLEFT", 280, -10)
    LunaOptionsFrame.pages[page].totemsizeslider:SetWidth(190)

    LunaOptionsFrame.pages[page].druidheader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    LunaOptionsFrame.pages[page].druidheader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].totemheader, "BOTTOMLEFT",
        0, -60)
    ...
    LunaOptionsFrame.pages[page].enabledruid = CreateFrame("CheckButton", "EnableplayerDruid",
        LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].enabledruid:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].druidheader, "BOTTOMLEFT",
        0, -10)
    ...
    LunaOptionsFrame.pages[page].druidsizeslider = CreateFrame("Slider", "DruidSizeSlidertarget",
        LunaOptionsFrame.pages[page], "OptionsSliderTemplate")
    ...
    LunaOptionsFrame.pages[page].druidsizeslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].druidheader,
        "BOTTOMLEFT", 280, -10)
    ...
    LunaOptionsFrame.pages[page].xpheader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    LunaOptionsFrame.pages[page].xpheader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].druidheader, "BOTTOMLEFT", 0,
        -60)
    ...
    LunaOptionsFrame.pages[page].enablexp = CreateFrame("CheckButton", "EnableplayerXP", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    ...
    LunaOptionsFrame.pages[page].xpsizeslider = CreateFrame("Slider", "XPSizeSliderplayer", LunaOptionsFrame.pages[page],
        "OptionsSliderTemplate")
    ...
    LunaOptionsFrame.pages[page].xpsizeslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].xpheader, "BOTTOMLEFT",
        280, -10)
    LunaOptionsFrame.pages[page].xpsizeslider:SetWidth(190)

    LunaOptionsFrame.pages[page].reckheader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    LunaOptionsFrame.pages[page].reckheader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].xpheader, "BOTTOMLEFT", 0,
        -60)
    ...
    LunaOptionsFrame.pages[page].enablereck = CreateFrame("CheckButton", "EnableReckStacks", LunaOptionsFrame.pages
        [page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].enablereck:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].reckheader, "BOTTOMLEFT", 0,
        -10)
    ...
    LunaOptionsFrame.pages[page].reckgrowth = CreateFrame("Button", "ReckGrowth", LunaOptionsFrame.pages[page],
        "UIDropDownMenuTemplate")
    LunaOptionsFrame.pages[page].reckgrowth:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].reckheader, "BOTTOMLEFT", 60,
        -10)
    ...
    LunaOptionsFrame.pages[page].reckgrDesc = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlightSmall")
    ...
    LunaOptionsFrame.pages[page].hidereck = CreateFrame("CheckButton", "HideReckStacks", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].hidereck:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].reckheader, "BOTTOMLEFT", 190,
        -10)
    ...
    LunaOptionsFrame.pages[page].recksizeslider = CreateFrame("Slider", "ReckSizeSliderplayer",
        LunaOptionsFrame.pages[page], "OptionsSliderTemplate")
    ...
    LunaOptionsFrame.pages[page].recksizeslider:SetScript("OnValueChanged", function()
        ...
        getglobal("ReckSizeSliderplayerText"):SetText(L["Size"] .. ": " .. LunaUF.db.profile.units.player.reckStacks
            .size)
        LunaUF.Units:SetupFrameModules(LunaUF.Units.unitFrames.player)
    end)
    ...
    LunaOptionsFrame.pages[page].enablexp = CreateFrame("CheckButton", "EnablepetXP", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].enablexp:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].xpheader, "BOTTOMLEFT", 0, -10)
    LunaOptionsFrame.pages[page].enablexp:SetHeight(30)
    LunaOptionsFrame.pages[page].enablexp:SetWidth(30)
    ...
    LunaOptionsFrame.pages[page].xpsizeslider = CreateFrame("Slider", "XPSizeSliderpet", LunaOptionsFrame.pages[page],
        "OptionsSliderTemplate")
    LunaOptionsFrame.pages[page].xpsizeslider:SetMinMaxValues(1, 10)
    LunaOptionsFrame.pages[page].xpsizeslider:SetValueStep(1)
    LunaOptionsFrame.pages[page].xpsizeslider:SetScript("OnValueChanged", function()
    ...
    local page = 5
    LunaOptionsFrame.pages[page].comboheader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    LunaOptionsFrame.pages[page].comboheader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].barorder, "BOTTOMLEFT", 0,
        -30)
    ...
    LunaOptionsFrame.pages[page].enablecombo = CreateFrame("CheckButton", "EnabletargetCombo",
        LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].enablecombo:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].comboheader, "BOTTOMLEFT",
        0, -10)
    ...
    LunaOptionsFrame.pages[page].combogrowth = CreateFrame("Button", "ComboGrowth", LunaOptionsFrame.pages[page],
        "UIDropDownMenuTemplate")
    LunaOptionsFrame.pages[page].combogrowth:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].comboheader, "BOTTOMLEFT",
        60, -10)
    ...
    LunaOptionsFrame.pages[page].combogrDesc = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlightSmall")
    ...
    LunaOptionsFrame.pages[page].hidecombo = CreateFrame("CheckButton", "HidetargetCombo", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].hidecombo:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].comboheader, "BOTTOMLEFT",
        190, -10)
    ...
    LunaOptionsFrame.pages[page].combosizeslider = CreateFrame("Slider", "ComboSizeSlidertarget",
        LunaOptionsFrame.pages[page], "OptionsSliderTemplate")
    ...
    LunaOptionsFrame.pages[page].combosizeslider:SetScript("OnValueChanged", function()
        ...
        getglobal("ComboSizeSlidertargetText"):SetText(L["Size"] .. ": " ..
            LunaUF.db.profile.units.target.comboPoints.size)
        LunaUF.Units:SetupFrameModules(LunaUF.Units.unitFrames.target)
    end)
    LunaOptionsFrame.pages[page].combosizeslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].comboheader,
        "BOTTOMLEFT", 280, -10)
    LunaOptionsFrame.pages[page].combosizeslider:SetWidth(190)

    LunaOptionsFrame.pages[page].kosheader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    LunaOptionsFrame.pages[page].kosheader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].enablecombo, "BOTTOMLEFT", 0,
        -30)
    ...
    LunaOptionsFrame.pages[page].enablekos = CreateFrame("CheckButton", "EnabletargetKos", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].enablekos:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].kosheader, "BOTTOMLEFT", 0,
        -10)
    ...
    LunaOptionsFrame.pages[page].enablekos:SetScript("OnClick", function()
        local unit = this:GetParent().id
        LunaUF.db.profile.units[unit].indicators.icons.elite.kos = not LunaUF.db.profile.units[unit].indicators.icons
            .elite.kos
        for _, frame in pairs(LunaUF.Units.frameList) do
            if frame.unitGroup == unit then
                LunaUF.Units:SetupFrameModules(frame)
    ...
    local page = 8
    LunaOptionsFrame.pages[page].rangedesc = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    LunaOptionsFrame.pages[page].rangedesc:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].barorder, "BOTTOMLEFT", 0,
        -30)
    ...
    LunaOptionsFrame.pages[page].enablerange = CreateFrame("CheckButton", "EnablepartyRange",
        LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].enablerange:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].rangedesc, "BOTTOMLEFT", 0,
        -10)
    ...
    LunaOptionsFrame.pages[page].partyrangealpha = CreateFrame("Slider", "AlphaSliderpartyRange",
        LunaOptionsFrame.pages[page], "OptionsSliderTemplate")
    ...
    LunaOptionsFrame.pages[page].partyrangealpha:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].enablerange, "TOPLEFT",
        200, 0)
    LunaOptionsFrame.pages[page].partyrangealpha:SetWidth(190)

    LunaOptionsFrame.pages[page].partyoptions = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    LunaOptionsFrame.pages[page].partyoptions:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].enablerange, "BOTTOMLEFT",
        0, -30)
    ...
    LunaOptionsFrame.pages[page].inraid = CreateFrame("CheckButton", "EnablepartyInRaid", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].inraid:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].partyoptions, "BOTTOMLEFT", 0,
        -10)
    ...
    LunaOptionsFrame.pages[page].playerparty = CreateFrame("CheckButton", "EnablePlayerparty",
        LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].playerparty:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].inraid, "BOTTOMLEFT", 0,
        -10)
    ...
    LunaOptionsFrame.pages[page].auratracker = CreateFrame("CheckButton", "EnablePartyAuratracker",
        LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
    ...
    LunaOptionsFrame.pages[page].partypadding = CreateFrame("Slider", "PartyPaddingSlider", LunaOptionsFrame.pages[page],
        "OptionsSliderTemplate")
    ...
    LunaOptionsFrame.pages[page].partypadding:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].partyoptions, "BOTTOMLEFT",
        270, -10)
    LunaOptionsFrame.pages[page].partypadding:SetWidth(200)

    LunaOptionsFrame.pages[page].sortby = CreateFrame("Button", "PartySortBy", LunaOptionsFrame.pages[page],
        "UIDropDownMenuTemplate")
    LunaOptionsFrame.pages[page].sortby:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].playerparty, "BOTTOMLEFT", -10,
        -20)
    ...
    UIDropDownMenu_Initialize(LunaOptionsFrame.pages[page].sortby, function()
        ...
        for k, v in pairs({ [L["Name"]] = "NAME", [L["Group"]] = "GROUP" }) do
            ...
            info.func = function()
                ...
                LunaUF.db.profile.units.party.sortby = UIDropDownMenu_GetSelectedValue(LunaOptionsFrame.pages[page]
                    .sortby)
                LunaUF.Units:LoadGroupHeader("party")
            end
            info.checked = nil
    ...
    LunaOptionsFrame.pages[page].sortDesc = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlightSmall")
    ...
    LunaOptionsFrame.pages[page].orderby = CreateFrame("Button", "PartyOrderBy", LunaOptionsFrame.pages[page],
        "UIDropDownMenuTemplate")
    LunaOptionsFrame.pages[page].orderby:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].playerparty, "BOTTOMLEFT", 140,
        -20)
    ...
    UIDropDownMenu_Initialize(LunaOptionsFrame.pages[page].orderby, function()
        ...
        for k, v in pairs({ [L["Ascending"]] = "ASC", [L["Descending"]] = "DESC" }) do
            ...
            info.func = function()
                ...
                LunaUF.db.profile.units.party.order = UIDropDownMenu_GetSelectedValue(LunaOptionsFrame.pages[page]
                    .orderby)
                LunaUF.Units:LoadGroupHeader("party")
            end
            info.checked = nil
    ...
    LunaOptionsFrame.pages[page].orderDesc = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlightSmall")
    ...
    LunaOptionsFrame.pages[page].growth = CreateFrame("Button", "PartyGrowth", LunaOptionsFrame.pages[page],
        "UIDropDownMenuTemplate")
    LunaOptionsFrame.pages[page].growth:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].playerparty, "BOTTOMLEFT", 300,
        -20)
    ...
    UIDropDownMenu_Initialize(LunaOptionsFrame.pages[page].growth, function()
        ...
        for k, v in pairs({ [L["LEFT"]] = "LEFT", [L["RIGHT"]] = "RIGHT", [L["UP"]] = "UP", [L["DOWN"]] = "DOWN" }) do
            ...
            info.func = function()
                ...
                LunaUF.db.profile.units.party.growth = UIDropDownMenu_GetSelectedValue(LunaOptionsFrame.pages[page]
                    .growth)
                LunaUF.Units:LoadGroupHeader("party")
            end
            info.checked = nil
    ...
    LunaOptionsFrame.pages[page].growthDesc = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlightSmall")
    ...
    local page = 11
    LunaOptionsFrame.pages[page].GrpSelDesc = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlightSmall")
    LunaOptionsFrame.pages[page].GrpSelDesc:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].positionsHeader,
        "BOTTOMLEFT", 0, -10)
    LunaOptionsFrame.pages[page].GrpSelDesc:SetText("GRP")

    LunaOptionsFrame.pages[page].GrpSelect = CreateFrame("Button", "GrpSelector", LunaOptionsFrame.pages[page],
        "UIDropDownMenuTemplate")
    ...
    UIDropDownMenu_Initialize(LunaOptionsFrame.pages[page].GrpSelect, function()
        ...
        for i = 1, 9 do
            ...
            info.func = function()
                ...
                LunaOptionsFrame.pages[page].xInput:SetText(LunaUF.db.profile.units["raid"][tonumber(this:GetText())]
                    .position.x)
                LunaOptionsFrame.pages[page].yInput:SetText(LunaUF.db.profile.units["raid"][tonumber(this:GetText())]
                    .position.y)
            end
            info.checked = nil
            info.checkable = nil
    ...
    LunaOptionsFrame.pages[page].enablerange = CreateFrame("CheckButton", "EnableraidRange", LunaOptionsFrame.pages
        [page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].enablerange:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].rangedesc, "BOTTOMLEFT", 0,
        -10)
    LunaOptionsFrame.pages[page].enablerange:SetHeight(30)
    ...
    LunaOptionsFrame.pages[page].raidrangealpha = CreateFrame("Slider", "AlphaSliderraidRange",
        LunaOptionsFrame.pages[page], "OptionsSliderTemplate")
    ...
    LunaOptionsFrame.pages[page].raidrangealpha:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].enablerange, "TOPLEFT",
        200, 0)
    LunaOptionsFrame.pages[page].raidrangealpha:SetWidth(190)

    LunaOptionsFrame.pages[page].healthAlphas = CreateFrame("CheckButton", "EnableHealthAlphas",
        LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].healthAlphas:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].enablerange, "BOTTOMLEFT",
        0, -10)
    ...
    LunaOptionsFrame.pages[page].healththresholdslider = CreateFrame("Slider", "HealthThresholdTracker",
        LunaOptionsFrame.pages[page], "OptionsSliderTemplate")
    ...
    LunaOptionsFrame.pages[page].healththresholdslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].healthAlphas,
        "BOTTOMLEFT", 0, -10)
    LunaOptionsFrame.pages[page].healththresholdslider:SetWidth(460)

    --In Range and Below Threshold Alpha slider
    LunaOptionsFrame.pages[page].inrangebelowthresholdslider = CreateFrame("Slider", "InRangeBelowThreshold",
        LunaOptionsFrame.pages[page], "OptionsSliderTemplate")
    ...
    LunaOptionsFrame.pages[page].inrangebelowthresholdslider:SetScript("OnValueChanged", function()
        ...
        getglobal("InRangeBelowThresholdText"):SetText(L["In Range and Below Limit"] ..
            " " .. L["Alpha"] .. ": " .. LunaUF.db.profile.units.raid.healththreshold.inRangeBelowAlpha)
    end)
    LunaOptionsFrame.pages[page].inrangebelowthresholdslider:SetPoint("TOPLEFT",
        LunaOptionsFrame.pages[page].healththresholdslider, "BOTTOMLEFT", 0, -30)
    LunaOptionsFrame.pages[page].inrangebelowthresholdslider:SetWidth(460)

    --In Range and Above Threshold Alpha slider
    LunaOptionsFrame.pages[page].inrangeabovethresholdslider = CreateFrame("Slider", "InRangeAboveThreshold",
        LunaOptionsFrame.pages[page], "OptionsSliderTemplate")
    ...
    LunaOptionsFrame.pages[page].inrangeabovethresholdslider:SetScript("OnValueChanged", function()
        ...
        getglobal("InRangeAboveThresholdText"):SetText(L["In Range and Above Limit"] ..
            " " .. L["Alpha"] .. ": " .. LunaUF.db.profile.units.raid.healththreshold.inRangeAboveAlpha)
    end)
    LunaOptionsFrame.pages[page].inrangeabovethresholdslider:SetPoint("TOPLEFT",
        LunaOptionsFrame.pages[page].inrangebelowthresholdslider, "BOTTOMLEFT", 0, -30)
    LunaOptionsFrame.pages[page].inrangeabovethresholdslider:SetWidth(460)


    --Out of Range and below Threshold Alpha slider
    LunaOptionsFrame.pages[page].outrangebelowthresholdslider = CreateFrame("Slider", "OutRangeBelowThreshold",
        LunaOptionsFrame.pages[page], "OptionsSliderTemplate")
    ...
    LunaOptionsFrame.pages[page].outrangebelowthresholdslider:SetScript("OnValueChanged", function()
        ...
        getglobal("OutRangeBelowThresholdText"):SetText(L["Out of Range and Below Limit"] ..
            " " .. L["Alpha"] .. ": " .. LunaUF.db.profile.units.raid.healththreshold.outOfRangeBelowAlpha)
    end)
    LunaOptionsFrame.pages[page].outrangebelowthresholdslider:SetPoint("TOPLEFT",
        LunaOptionsFrame.pages[page].inrangeabovethresholdslider, "BOTTOMLEFT", 0, -30)
    LunaOptionsFrame.pages[page].outrangebelowthresholdslider:SetWidth(460)

    LunaOptionsFrame.pages[page].trackerDesc = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    LunaOptionsFrame.pages[page].trackerDesc:SetPoint("TOPLEFT",
        LunaOptionsFrame.pages[page].outrangebelowthresholdslider, "BOTTOMLEFT", 0, -30)
    ...
    LunaOptionsFrame.pages[page].enabletracker = CreateFrame("CheckButton", "EnableSquares", LunaOptionsFrame.pages
        [page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].enabletracker:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].trackerDesc, "BOTTOMLEFT",
        0, -10)
    ...
    LunaOptionsFrame.pages[page].outersizeslider = CreateFrame("Slider", "OuterSizeSliderTracker",
        LunaOptionsFrame.pages[page], "OptionsSliderTemplate")
    ...
    LunaOptionsFrame.pages[page].outersizeslider:SetScript("OnValueChanged", function()
        ...
        getglobal("OuterSizeSliderTrackerText"):SetText(L["Size"] .. ": " ..
            LunaUF.db.profile.units.raid.squares.outersize)
        for _, frame in pairs(LunaUF.Units.frameList) do
            if frame.unitGroup == "raid" then
                LunaUF.Units:SetupFrameModules(frame)
            end
    ...
    LunaOptionsFrame.pages[page].outersizeslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].trackerDesc,
        "BOTTOMLEFT", 200, -10)
    LunaOptionsFrame.pages[page].outersizeslider:SetWidth(230)

    LunaOptionsFrame.pages[page].enabledebuffs = CreateFrame("CheckButton", "EnableDebuffs", LunaOptionsFrame.pages
        [page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].enabledebuffs:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].enabletracker,
        "BOTTOMLEFT", 0, -10)
    ...
    LunaOptionsFrame.pages[page].dispdebuffs = CreateFrame("CheckButton", "EnableDispDebuffs",
        LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].dispdebuffs:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].enabletracker, "BOTTOMLEFT",
        200, -10)
    ...
    LunaOptionsFrame.pages[page].dispdebuffs:SetScript("OnClick", function()
        LunaUF.db.profile.units.raid.squares.dispellabledebuffs = not LunaUF.db.profile.units.raid.squares
            .dispellabledebuffs
        for _, frame in pairs(LunaUF.Units.frameList) do
            if frame.unitGroup == "raid" then
                LunaUF.Units.FullUpdate(frame)
    ...
    LunaOptionsFrame.pages[page].owndebuffs = CreateFrame("CheckButton", "EnableOwnDebuffs", LunaOptionsFrame.pages
        [page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].owndebuffs:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].enabletracker, "BOTTOMLEFT",
        200, -40)
    ...
    LunaOptionsFrame.pages[page].aggro = CreateFrame("CheckButton", "EnableAggro", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].aggro:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].enabledebuffs, "BOTTOMLEFT", 0,
        -50)
    ...
    LunaOptionsFrame.pages[page].aggrocolor = CreateColorSelect(LunaOptionsFrame.pages[page],
        LunaUF.db.profile.units.raid.squares.aggrocolor, "AggroColorSelect")
    ...
    LunaOptionsFrame.pages[page].hottracker = CreateFrame("CheckButton", "EnableHotTracker", LunaOptionsFrame.pages
        [page], "UICheckButtonTemplate")
    ...
    LunaOptionsFrame.pages[page].innersizeslider = CreateFrame("Slider", "InnerSizeSliderTracker",
        LunaOptionsFrame.pages[page], "OptionsSliderTemplate")
    ...
    LunaOptionsFrame.pages[page].innersizeslider:SetScript("OnValueChanged", function()
        ...
        getglobal("InnerSizeSliderTrackerText"):SetText(L["Size"] .. ": " ..
            LunaUF.db.profile.units.raid.squares.innersize)
        for _, frame in pairs(LunaUF.Units.frameList) do
            if frame.unitGroup == "raid" then
                LunaUF.Units:SetupFrameModules(frame)
            end
    ...
    LunaOptionsFrame.pages[page].innersizeslider:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].hottracker, "TOPLEFT",
        200, 0)
    LunaOptionsFrame.pages[page].innersizeslider:SetWidth(230)

    LunaOptionsFrame.pages[page].buffcolors = CreateFrame("CheckButton", "EnableBuffColorsTracker",
        LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].buffcolors:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].hottracker, "BOTTOMLEFT", 0,
        -10)
    ...
    LunaOptionsFrame.pages[page].debuffcolors = CreateFrame("CheckButton", "EnableDebuffColorsTracker",
        LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].debuffcolors:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].hottracker, "BOTTOMLEFT",
        200, -10)
    ...
    LunaOptionsFrame.pages[page].buffheader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlightSmall")
    LunaOptionsFrame.pages[page].buffheader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].buffcolors, "BOTTOMLEFT", 0,
        -20)
    ...
    LunaOptionsFrame.pages[page].firstbuff = CreateFrame("Editbox", "FirstBuffInput", LunaOptionsFrame.pages[page],
        "InputBoxTemplate")
    ...
    LunaOptionsFrame.pages[page].firstbuff:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].buffheader, "BOTTOMLEFT", 0,
        -10)
    ...
    LunaOptionsFrame.pages[page].firstbuffcolor = CreateColorSelect(LunaOptionsFrame.pages[page],
        LunaUF.db.profile.units.raid.squares.buffs.colors[1])
    ...
    LunaOptionsFrame.pages[page].firstbuffinvert = CreateFrame("CheckButton", "FirstBuffInvert",
        LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].firstbuffinvert:SetPoint("LEFT", LunaOptionsFrame.pages[page].firstbuffcolor, "RIGHT",
        70, 0)
    ...
    LunaOptionsFrame.pages[page].secondbuff = CreateFrame("Editbox", "SecondBuffInput", LunaOptionsFrame.pages[page],
        "InputBoxTemplate")
    ...
    LunaOptionsFrame.pages[page].secondbuff:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].firstbuff, "BOTTOMLEFT", 0,
        -10)
    ...
    LunaOptionsFrame.pages[page].secondbuffcolor = CreateColorSelect(LunaOptionsFrame.pages[page],
        LunaUF.db.profile.units.raid.squares.buffs.colors[2])
    ...
    LunaOptionsFrame.pages[page].secondbuffinvert = CreateFrame("CheckButton", "SecondBuffInvert",
        LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].secondbuffinvert:SetPoint("LEFT", LunaOptionsFrame.pages[page].secondbuffcolor, "RIGHT",
        70, 0)
    ...
    LunaOptionsFrame.pages[page].secondbuffinvert:SetScript("OnClick", function()
        LunaUF.db.profile.units.raid.squares.invertsecondbuff = not LunaUF.db.profile.units.raid.squares
            .invertsecondbuff
        for _, frame in pairs(LunaUF.Units.frameList) do
            if frame.unitGroup == "raid" then
                LunaUF.Units.FullUpdate(frame)
    ...
    LunaOptionsFrame.pages[page].thirdbuff = CreateFrame("Editbox", "ThirdBuffInput", LunaOptionsFrame.pages[page],
        "InputBoxTemplate")
    ...
    LunaOptionsFrame.pages[page].thirdbuff:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].secondbuff, "BOTTOMLEFT", 0,
        -10)
    ...
    LunaOptionsFrame.pages[page].thirdbuffcolor = CreateColorSelect(LunaOptionsFrame.pages[page],
        LunaUF.db.profile.units.raid.squares.buffs.colors[3])
    ...
    LunaOptionsFrame.pages[page].thirdbuffinvert = CreateFrame("CheckButton", "ThirdBuffInvert",
        LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].thirdbuffinvert:SetPoint("LEFT", LunaOptionsFrame.pages[page].thirdbuffcolor, "RIGHT",
        70, 0)
    ...
    LunaOptionsFrame.pages[page].debuffheader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlightSmall")
    LunaOptionsFrame.pages[page].debuffheader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].thirdbuff, "BOTTOMLEFT", 0,
        -10)
    LunaOptionsFrame.pages[page].debuffheader:SetText(L["Debuffs to track"])

    LunaOptionsFrame.pages[page].firstdebuff = CreateFrame("Editbox", "FirstDebuffInput", LunaOptionsFrame.pages[page],
        "InputBoxTemplate")
    ...
    LunaOptionsFrame.pages[page].firstdebuff:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].debuffheader, "BOTTOMLEFT",
        0, -10)
    ...
    LunaOptionsFrame.pages[page].firstdebuffcolor = CreateColorSelect(LunaOptionsFrame.pages[page],
        LunaUF.db.profile.units.raid.squares.debuffs.colors[1])
    LunaOptionsFrame.pages[page].firstdebuffcolor:SetPoint("LEFT", LunaOptionsFrame.pages[page].firstdebuff, "RIGHT", 10,
        0)
    ...
    LunaOptionsFrame.pages[page].seconddebuff = CreateFrame("Editbox", "SecondDebuffInput", LunaOptionsFrame.pages[page],
        "InputBoxTemplate")
    ...
    LunaOptionsFrame.pages[page].seconddebuff:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].firstdebuff, "BOTTOMLEFT",
        0, -10)
    ...
    LunaOptionsFrame.pages[page].seconddebuffcolor = CreateColorSelect(LunaOptionsFrame.pages[page],
        LunaUF.db.profile.units.raid.squares.debuffs.colors[2])
    LunaOptionsFrame.pages[page].seconddebuffcolor:SetPoint("LEFT", LunaOptionsFrame.pages[page].seconddebuff, "RIGHT",
        10, 0)
    ...
    LunaOptionsFrame.pages[page].thirddebuff = CreateFrame("Editbox", "ThirdDebuffInput", LunaOptionsFrame.pages[page],
        "InputBoxTemplate")
    ...
    LunaOptionsFrame.pages[page].thirddebuff:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].seconddebuff, "BOTTOMLEFT",
        0, -10)
    ...
    LunaOptionsFrame.pages[page].thirddebuffcolor = CreateColorSelect(LunaOptionsFrame.pages[page],
        LunaUF.db.profile.units.raid.squares.debuffs.colors[3])
    LunaOptionsFrame.pages[page].thirddebuffcolor:SetPoint("LEFT", LunaOptionsFrame.pages[page].thirddebuff, "RIGHT", 10,
        0)
    ...
    LunaOptionsFrame.pages[page].raidoptions = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    LunaOptionsFrame.pages[page].raidoptions:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].thirddebuff, "BOTTOMLEFT",
        0, -30)
    ...
    LunaOptionsFrame.pages[page].showparty = CreateFrame("CheckButton", "PartyInRaidFrames", LunaOptionsFrame.pages
        [page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].showparty:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].raidoptions, "BOTTOMLEFT", 0,
        -10)
    ...
    LunaOptionsFrame.pages[page].showalways = CreateFrame("CheckButton", "AlwaysShowRaid", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].showalways:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].raidoptions, "BOTTOMLEFT",
        150, -10)
    ...
    LunaOptionsFrame.pages[page].raidpadding = CreateFrame("Slider", "RaidPaddingSlider", LunaOptionsFrame.pages[page],
        "OptionsSliderTemplate")
    ...
    LunaOptionsFrame.pages[page].raidpadding:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].raidoptions, "BOTTOMLEFT",
        270, -15)
    LunaOptionsFrame.pages[page].raidpadding:SetWidth(200)

    LunaOptionsFrame.pages[page].interlock = CreateFrame("CheckButton", "InterlockRaidFrames",
        LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].interlock:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].showparty, "BOTTOMLEFT", 0,
        -10)
    ...
    LunaOptionsFrame.pages[page].interlock:SetScript("OnClick", function()
        ...
        if LunaUF.db.profile.units.raid.interlock then -- Frames 2-9 just snapped to frame 1 so save their new position
            for i = 2, 9 do
                ...
                LunaUF.db.profile.units.raid[i].position.y = (UIParent:GetHeight() / UIParent:GetScale() - LunaUF.Units.headerFrames["raid" .. i]:GetTop()) *
                    -1
            end
        end
    end)
    ...
    LunaOptionsFrame.pages[page].interlockgrowth = CreateFrame("Button", "InterlockGrowthRaid",
        LunaOptionsFrame.pages[page], "UIDropDownMenuTemplate")
    LunaOptionsFrame.pages[page].interlockgrowth:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].showparty, "BOTTOMLEFT",
        140, -10)
    ...
    UIDropDownMenu_Initialize(LunaOptionsFrame.pages[page].interlockgrowth, function()
        ...
        for k, v in pairs({ [L["LEFT"]] = "LEFT", [L["RIGHT"]] = "RIGHT", [L["UP"]] = "UP", [L["DOWN"]] = "DOWN" }) do
            ...
            info.func = function()
                ...
                LunaUF.db.profile.units.raid.interlockgrowth = UIDropDownMenu_GetSelectedValue(LunaOptionsFrame.pages
                    [page].interlockgrowth)
                LunaUF.Units:LoadRaidGroupHeader()
            end
            info.checked = nil
            info.checkable = nil
    ...
    LunaOptionsFrame.pages[page].intergrDesc = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlightSmall")
    ...
    LunaOptionsFrame.pages[page].petgrp = CreateFrame("CheckButton", "EnablePetGrp", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    ...
    LunaOptionsFrame.pages[page].titles = CreateFrame("CheckButton", "RaidGrpTitles", LunaOptionsFrame.pages[page],
        "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].titles:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].interlock, "BOTTOMLEFT", 150,
        -10)
    ...
    LunaOptionsFrame.pages[page].sortby = CreateFrame("Button", "RaidSortBy", LunaOptionsFrame.pages[page],
        "UIDropDownMenuTemplate")
    ...
    UIDropDownMenu_Initialize(LunaOptionsFrame.pages[page].sortby, function()
        ...
        for k, v in pairs({ [L["Name"]] = "NAME", [L["Group"]] = "GROUP" }) do
            ...
            info.func = function()
                UIDropDownMenu_SetSelectedValue(LunaOptionsFrame.pages[page].sortby, this.value)
                LunaUF.db.profile.units.raid.sortby = UIDropDownMenu_GetSelectedValue(LunaOptionsFrame.pages[page]
                    .sortby)
                LunaUF.Units:LoadRaidGroupHeader()
            end
            info.checked = nil
    ...
    LunaOptionsFrame.pages[page].orderby = CreateFrame("Button", "RaidOrderBy", LunaOptionsFrame.pages[page],
        "UIDropDownMenuTemplate")
    ...
    UIDropDownMenu_Initialize(LunaOptionsFrame.pages[page].orderby, function()
        ...
        for k, v in pairs({ [L["Ascending"]] = "ASC", [L["Descending"]] = "DESC" }) do
            ...
            info.func = function()
                UIDropDownMenu_SetSelectedValue(LunaOptionsFrame.pages[page].orderby, this.value)
                LunaUF.db.profile.units.raid.order = UIDropDownMenu_GetSelectedValue(LunaOptionsFrame.pages[page]
                    .orderby)
                LunaUF.Units:LoadRaidGroupHeader()
            end
            info.checked = nil
    ...
    LunaOptionsFrame.pages[page].growth = CreateFrame("Button", "RaidGrowth", LunaOptionsFrame.pages[page],
        "UIDropDownMenuTemplate")
    ...
    UIDropDownMenu_Initialize(LunaOptionsFrame.pages[page].growth, function()
        ...
        for k, v in pairs({ [L["LEFT"]] = "LEFT", [L["RIGHT"]] = "RIGHT", [L["UP"]] = "UP", [L["DOWN"]] = "DOWN" }) do
            ...
            info.func = function()
                UIDropDownMenu_SetSelectedValue(LunaOptionsFrame.pages[page].growth, this.value)
                LunaUF.db.profile.units.raid.growth = UIDropDownMenu_GetSelectedValue(LunaOptionsFrame.pages[page]
                    .growth)
                LunaUF.Units:LoadRaidGroupHeader()
            end
            info.checked = nil
    ...
    LunaOptionsFrame.pages[page].mode = CreateFrame("Button", "RaidMode", LunaOptionsFrame.pages[page],
        "UIDropDownMenuTemplate")
    ...
    LunaOptionsFrame.pages[page].modeDesc = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlightSmall")
    ...
    local page = 12
    LunaOptionsFrame.pages[page].mouseDownClicks = CreateFrame("CheckButton", "MouseDownClicks",
        LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
    ...
    LunaOptionsFrame.pages[page].mouseDownClicks:SetScript("OnClick", function()
        ...
        for _, frame in pairs(LunaUF.Units.frameList) do
            frame:RegisterForClicks('LeftButton' .. click_action, 'RightButton' .. click_action,
                'MiddleButton' .. click_action, 'Button4' .. click_action, 'Button5' .. click_action)
        end
    end)
    getglobal("MouseDownClicksText"):SetText(L["Cast on mouse down"])

    LunaOptionsFrame.pages[page].Button = CreateFrame("Button", "ClickCastBindButton", LunaOptionsFrame.pages[page],
        "UIPanelButtonTemplate")
    LunaOptionsFrame.pages[page].Button:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].mouseDownClicks, "BOTTOMLEFT", 0,
        -30)
    ...
    LunaOptionsFrame.pages[page].Button:RegisterForClicks('LeftButtonUp', 'RightButtonUp', 'MiddleButtonUp', 'Button4Up',
        'Button5Up')
    LunaOptionsFrame.pages[page].Button:SetScript("OnClick", function()
        this:SetText((IsControlKeyDown() and "Ctrl-" or "") ..
            (IsShiftKeyDown() and "Shift-" or "") .. (IsAltKeyDown() and "Alt-" or "") .. L[arg1])
    end)

    LunaOptionsFrame.pages[page].input = CreateFrame("Editbox", "ClickCastInput", LunaOptionsFrame.pages[page],
        "InputBoxTemplate")
    ...
    LunaOptionsFrame.pages[page].Add = CreateFrame("Button", "ClickCastAddButton", LunaOptionsFrame.pages[page],
        "UIPanelButtonTemplate")
    ...
    for i = 1, 40 do
        LunaOptionsFrame.pages[page].bindtexts[i] = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlight")
        LunaOptionsFrame.pages[page].bindtexts[i]:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].Add, "BOTTOM", -220,
            -20 * i)
        LunaOptionsFrame.pages[page].bindtexts[i]:SetJustifyH("LEFT")
        LunaOptionsFrame.pages[page].bindtexts[i]:SetTextColor(1, 1, 0)

        LunaOptionsFrame.pages[page].actiontexts[i] = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
            "GameFontHighlight")
        LunaOptionsFrame.pages[page].actiontexts[i]:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].Add, "BOTTOM", -40,
            -20 * i)
        LunaOptionsFrame.pages[page].actiontexts[i]:SetJustifyH("LEFT")
        LunaOptionsFrame.pages[page].actiontexts[i]:SetTextColor(1, 1, 1)

        LunaOptionsFrame.pages[page].delbuttons[i] = CreateFrame("Button", "ClickCastDelButton" .. i,
            LunaOptionsFrame.pages[page], "UIPanelButtonTemplate")
        LunaOptionsFrame.pages[page].delbuttons[i]:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].Add, "BOTTOM", 220,
            -20 * i)
    ...
    local page = 13
    LunaOptionsFrame.pages[page].topHeader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    ...
    LunaOptionsFrame.pages[page].resetAll = CreateFrame("Button", "LunaResetAllColors", LunaOptionsFrame.pages[page],
        "UIPanelButtonTemplate")
    ...
    LunaOptionsFrame.pages[page].cColorHeader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    ...
    for i, class in ipairs({ "PRIEST", "PALADIN", "SHAMAN", "WARRIOR", "ROGUE", "MAGE", "WARLOCK", "DRUID", "HUNTER" }) do
        LunaOptionsFrame.pages[page][class] = CreateColorSelect(LunaOptionsFrame.pages[page],
            LunaUF.db.profile.classColors[class])
        LunaOptionsFrame.pages[page][class]:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page], "TOPLEFT",
            20 + (((i - (3 * math.floor((i - 1) / 3))) - 1) * 120), -130 - (math.floor((i - 1) / 3) * 30))
    ...
    LunaOptionsFrame.pages[page].hColorHeader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    ...
    for name, options in pairs(LunaUF.db.profile.healthColors) do
        ...
        LunaOptionsFrame.pages[page][name]:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page], "TOPLEFT",
            20 + (((num - (4 * math.floor((num - 1) / 4))) - 1) * 120), -260 - (math.floor((num - 1) / 4) * 30))
    ...
    LunaOptionsFrame.pages[page].pColorHeader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    ...
    for name, options in pairs(LunaUF.db.profile.powerColors) do
        LunaOptionsFrame.pages[page][name] = CreateColorSelect(LunaOptionsFrame.pages[page], options)
        LunaOptionsFrame.pages[page][name]:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page], "TOPLEFT",
            20 + (((num - (3 * math.floor((num - 1) / 3))) - 1) * 120), -390 - (math.floor((num - 1) / 3) * 30))
        LunaOptionsFrame.pages[page][name]:SetHeight(19)
        LunaOptionsFrame.pages[page][name]:SetWidth(19)
        LunaOptionsFrame.pages[page][name].text:SetText(L[name])
        num = num + 1
    ...
    LunaOptionsFrame.pages[page].castColorHeader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    ...
    for name, options in pairs(LunaUF.db.profile.castColors) do
        LunaOptionsFrame.pages[page][name] = CreateColorSelect(LunaOptionsFrame.pages[page], options)
        LunaOptionsFrame.pages[page][name]:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page], "TOPLEFT",
            20 + (((num - (3 * math.floor((num - 1) / 3))) - 1) * 120), -490 - (math.floor((num - 1) / 3) * 30))
        LunaOptionsFrame.pages[page][name]:SetHeight(19)
        LunaOptionsFrame.pages[page][name]:SetWidth(19)
        LunaOptionsFrame.pages[page][name].text:SetText(L[name])
        num = num + 1
    ...
    LunaOptionsFrame.pages[page].xpColorHeader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    ...
    for name, options in pairs(LunaUF.db.profile.xpColors) do
        LunaOptionsFrame.pages[page][name] = CreateColorSelect(LunaOptionsFrame.pages[page], options)
        LunaOptionsFrame.pages[page][name]:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page], "TOPLEFT",
            20 + (((num - (3 * math.floor((num - 1) / 3))) - 1) * 120), -540 - (math.floor((num - 1) / 3) * 30))
        LunaOptionsFrame.pages[page][name]:SetHeight(19)
        LunaOptionsFrame.pages[page][name]:SetWidth(19)
        LunaOptionsFrame.pages[page][name].text:SetText(L[name])
        num = num + 1
    ...
    LunaOptionsFrame.pages[page].NewProfileHeader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    ...
    LunaOptionsFrame.pages[page].input = CreateFrame("Editbox", "NewProfileInput", LunaOptionsFrame.pages[page],
        "InputBoxTemplate")
    LunaOptionsFrame.pages[page].input:SetHeight(20)
    LunaOptionsFrame.pages[page].input:SetWidth(200)
    LunaOptionsFrame.pages[page].input:SetAutoFocus(nil)
    LunaOptionsFrame.pages[page].input:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].NewProfileHeader, "BOTTOMLEFT", 0,
        -10)
    ...
    LunaOptionsFrame.pages[page].Add = CreateFrame("Button", "NewProfileAddButton", LunaOptionsFrame.pages[page],
        "UIPanelButtonTemplate")
    ...
    LunaOptionsFrame.pages[page].Add:SetScript("OnClick", function()
        ...
        LunaUF:SetProfile(ProfileName,
            UIDropDownMenu_GetSelectedValue(LunaOptionsFrame.pages[page].CopySelect) ~= "" and
            UIDropDownMenu_GetSelectedValue(LunaOptionsFrame.pages[page].CopySelect) or nil)
    ...
    LunaOptionsFrame.pages[page].CopySelect = CreateFrame("Button", "CopySelect", LunaOptionsFrame.pages[page],
        "UIDropDownMenuTemplate")
    ...
    LunaOptionsFrame.pages[page].hint = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlightSmall")
    ...
    LunaOptionsFrame.pages[page].SelectProfileHeader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    LunaOptionsFrame.pages[page].SelectProfileHeader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].NewProfileHeader,
        "TOPLEFT", 0, -80)
    ...
    LunaOptionsFrame.pages[page].ProfileSelect = CreateFrame("Button", "ProfileSelect", LunaOptionsFrame.pages[page],
        "UIDropDownMenuTemplate")
    LunaOptionsFrame.pages[page].ProfileSelect:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].SelectProfileHeader,
        "BOTTOMLEFT", -22, -10)
    ...
    LunaOptionsFrame.pages[page].reset = CreateFrame("Button", "ProfileResetButton", LunaOptionsFrame.pages[page],
        "UIPanelButtonTemplate")
    LunaOptionsFrame.pages[page].reset:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].SelectProfileHeader, "BOTTOMLEFT",
        -5, -40)
    ...
    LunaOptionsFrame.pages[page].delete = CreateFrame("Button", "ProfileResetButton", LunaOptionsFrame.pages[page],
        "UIPanelButtonTemplate")
    ...
    LunaOptionsFrame.pages[page].ProfileSwitcherHeader = LunaOptionsFrame.pages[page]:CreateFontString(nil, "OVERLAY",
        "GameFontHighlight")
    LunaOptionsFrame.pages[page].ProfileSwitcherHeader:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].delete, "TOPLEFT",
        0, -50)
    ...
    LunaOptionsFrame.pages[page].enableSwitch = CreateFrame("CheckButton", "EnableSwitchProfiles",
        LunaOptionsFrame.pages[page], "UICheckButtonTemplate")
    LunaOptionsFrame.pages[page].enableSwitch:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].ProfileSwitcherHeader,
        "TOPLEFT", 0, -30)
    ...
    LunaOptionsFrame.pages[page].ProfileSolo = CreateFrame("Button", "ProfileSolo", LunaOptionsFrame.pages[page],
        "UIDropDownMenuTemplate")
    LunaOptionsFrame.pages[page].ProfileSolo:SetPoint("TOPLEFT", LunaOptionsFrame.pages[page].enableSwitch, "TOPLEFT", 0,
        -30)
    ...
    UIDropDownMenu_SetSelectedValue(LunaOptionsFrame.pages[page].ProfileSolo,
        (LunaDB.ProfileSwitcherData["Solo"] or "Default"))
    ...
    LunaOptionsFrame.HelpFrameSlider:SetScript("OnValueChanged",
        function() this.ScrollFrame:SetVerticalScroll(this.ScrollFrame:GetVerticalScrollRange() * this:GetValue()) end)

    LunaOptionsFrame.helpframescrollchild = CreateFrame("Frame", "helpframescrollchild", LunaOptionsFrame
        .HelpScrollFrame)
    LunaOptionsFrame.helpframescrollchild:SetHeight(1)
    LunaOptionsFrame.helpframescrollchild:SetWidth(300)

    LunaOptionsFrame.helpframescrollchild.title = LunaOptionsFrame.helpframescrollchild:CreateFontString(nil, "OVERLAY",
        LunaOptionsFrame.helpframescrollchild)
    ...
    for _, l in pairs({ "INFO TAGS", "HEALTH AND POWER TAGS", "COLOR TAGS" }) do
        l = L[l]
        LunaOptionsFrame.helpframescrollchild.texts[count] = LunaOptionsFrame.helpframescrollchild:CreateFontString(nil,
            "OVERLAY", LunaOptionsFrame.helpframescrollchild)
        ...
        for k, v in pairs(TagsDescs[l]) do
            LunaOptionsFrame.helpframescrollchild.texts[count] = LunaOptionsFrame.helpframescrollchild:CreateFontString(
                nil, "OVERLAY", LunaOptionsFrame.helpframescrollchild)
            LunaOptionsFrame.helpframescrollchild.texts[count]:SetFont(defaultFont, 9)
            LunaOptionsFrame.helpframescrollchild.texts[count]:SetText("\124cffffff00" .. "[" .. k ..
                "]\124cffffffff: " .. v)
            LunaOptionsFrame.helpframescrollchild.texts[count]:SetJustifyH("LEFT")
            LunaOptionsFrame.helpframescrollchild.texts[count]:SetJustifyV("TOP")
